...
export const metadata: Metadata = {
  ...
  description:
    'Explore TiDB and TiDB Cloud integrations -- Kubernetes Operator, Kafka CDC, Spark (TiSpark), Terraform, and more. Deploy faster with TiDB.',
  ...
  sections: [
    {
      ...
      props: {
        ...
        subheadline:
          'TiDB and TiDB Cloud integrate with the tools modern engineering teams already run. Fully MySQL protocol compatible with standard drivers, JDBC, ODBC, and popular ORMs like Hibernate, Prisma, and SQLAlchemy.',
        primaryCta: {
          text: 'Start for Free',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Run, scale, and monitor TiDB in production using cloud-native orchestration and observability tooling.',
        items: [
          {
            icon: {
            ...
            description:
              'Deploy and manage TiDB clusters natively on Kubernetes with automated scaling, upgrades, backup, and self-healing.',
          ...
          },
          {
            ...
            title: 'Prometheus',
            description:
              'Collect real-time performance metrics from TiDB clusters for monitoring, alerting, and operational visibility.',
          ...
          },
          {
            ...
            title: 'Grafana',
            description:
              'Visualize TiDB performance metrics with prebuilt dashboards for cluster health, query latency, and storage insights.',
            href: 'https://docs.pingcap.com/tidbcloud/monitor-prometheus-and-grafana-integration/',
          },
          {
            icon: {
            ...
            title: 'Datadog',
            description:
              'Export TiDB metrics into Datadog for centralized monitoring across cloud-native infrastructure.',
          ...
          },
          {
            ...
            title: 'New Relic',
            description:
              'Integrate TiDB observability data into New Relic APM workflows for full-stack monitoring.',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          ' Most integrations rely on open standards like JDBC and ODBC — reducing friction when migrating or modernizing existing workloads. If you are modernizing legacy systems, see how to Modernize MySQL workloads with TiDB.',
        image: {
          image: {
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Real-time architectures depend on reliable change data capture and event streaming. TiDB supports CDC via TiCDC.',
        items: [
          {
            icon: {
            ...
            description:
              'Stream real-time changes from TiDB to Kafka using TiCDC for event-driven architectures and data pipelines.',
          ...
          },
          {
            ...
            title: 'Apache Flink',
            description:
              'Consume TiDB change streams in Flink for stateful stream processing and real-time analytics.',
            href: 'https://docs.pingcap.com/tidb/stable/replicate-data-to-kafka/',
          },
          {
            icon: {
            ...
            title: 'Confluent',
            description:
              'Deliver TiDB change events into Confluent-compatible Kafka deployments for scalable streaming workflows.',
          ...
          },
          {
            ...
            title: 'Airbyte',
            description:
              'Use Airbyte connectors to move data into or out of TiDB for modern ELT pipelines.',
          ...
          },
          {
            ...
            description:
              'Integrate SaaS data into TiDB via AWS AppFlow for cloud-native data movement workflows.',
          ...
          },
          {
            ...
            title: 'dbt',
            description:
              'Transform TiDB data using dbt in ELT pipelines for analytics engineering and modeling.',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'TiDB is an HTAP database — handle transactional and analytical workloads on the same data without ETL duplication.',
        items: [
          {
            icon: {
            ...
            description:
              'Run distributed Spark SQL queries directly on TiDB using TiSpark for large-scale analytics without ETL duplication.',
          ...
          },
          {
            ...
            title: 'Tableau',
            description:
              'Connect Tableau dashboards to TiDB for interactive visual analytics and business intelligence.',
            href: 'https://docs.pingcap.com/',
          },
          {
            icon: {
            ...
            title: 'PowerBI',
            description:
              'Integrate TiDB with Microsoft Power BI for unified data visualization and reporting.',
            href: 'https://docs.pingcap.com/',
          },
          {
            icon: {
            ...
            title: 'Looker',
            description:
              "Build self-service analytics with Looker's semantic layer connected to TiDB data.",
            href: 'https://docs.pingcap.com/',
          },
          {
            icon: {
            ...
            description:
              'Create interactive, real-time dashboards with Superset using TiDB as a native data source.',
            href: 'https://docs.pingcap.com/',
          },
        ],
        columns: 3,
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'TiDB is MySQL protocol compatible — all standard drivers work without modification.',
        items: [
          {
            icon: {
            ...
            title: 'JDBC and ODBC',
            description:
              'Standard Java and system-level database connectivity with full ACID and transactional support.',
          ...
          },
          {
            ...
            description:
              'Connect Python applications using SQLAlchemy ORM and PyMySQL driver with native MySQL compatibility.',
          ...
          },
          {
            ...
            description:
              'Use Prisma and Sequelize ORMs for Node.js with TiDB as a drop-in MySQL replacement.',
          ...
          },
          {
            ...
            description:
              'Build Go applications with gorm and standard database/sql packages connecting to TiDB.',
          ...
          },
          {
            ...
            description:
              'Use Hibernate with TiDB for object-relational mapping in Java enterprise applications.',
          ...
          },
          {
            ...
            title: 'ProxySQL',
            description:
              'Use ProxySQL for connection pooling and traffic routing in TiDB-compatible environments.',
        ...
        items: [
          {
            ...
            title: 'AWS',
            description:
              'Deploy TiDB Cloud on AWS, access via CloudFormation, and use AWS AppFlow for data integration.',
          ...
          },
          {
            ...
            description:
              'Run TiDB on Google Cloud Bigtable or self-host with native GCP marketplace integrations.',
          ...
          },
          {
            ...
            description:
              'Deploy TiDB on Azure Kubernetes Service (AKS) with Azure Marketplace support.',
          ...
          },
          {
            ...
            title: 'Alibaba Cloud',
            description:
              'TiDB deployments on Alibaba Cloud with native marketplace and managed service options.',
          ...
          },
          {
            ...
            description:
              'Deploy TiDB on your own infrastructure using Kubernetes Operator or binary installation.',
            href: 'https://docs.pingcap.com/tidb-in-kubernetes/stable/',
          },
        ],
        columns: 3,
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Provision, manage, and govern TiDB clusters using infrastructure-as-code and database DevOps workflows.',
        items: [
          {
            icon: {
            ...
            description:
              'Provision and manage TiDB Cloud clusters using Terraform for infrastructure-as-code workflows.',
          ...
          },
          {
            ...
            title: 'Bytebase',
            description:
              'Manage TiDB schema migrations and database DevOps workflows with version control and approvals.',
          ...
          },
          {
            ...
            title: 'Gitpod',
            description:
              'Spin up cloud-based development environments connected to TiDB for rapid prototyping.',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Connect modern serverless, SaaS, and edge applications to TiDB using standard MySQL-compatible drivers.',
        items: [
          {
            icon: {
            ...
            title: 'Vercel',
            description:
              'Connect serverless and SaaS backends on Vercel to TiDB Cloud using standard MySQL drivers.',
          ...
          },
          {
            ...
            title: 'Netlify',
            description:
              'Integrate Netlify-hosted applications with TiDB via MySQL-compatible connectors.',
          ...
          },
          {
            ...
            title: 'AWS Lambda',
            description:
              'Use Lambda functions to query or write to TiDB using standard MySQL connectors in serverless architectures.',
          ...
          },
          {
            ...
            title: 'Cloudflare',
            description:
              'Build globally distributed applications connecting Cloudflare workers to TiDB Cloud endpoints.',
          ...
          },
          {
            ...
            title: 'Zapier',
            description:
              'Automate workflows triggered by TiDB data changes using Zapier integrations.',
          ...
          },
          {
            ...
            title: 'n8n',
            description:
              'Create event-driven automation workflows integrating TiDB with SaaS tools via n8n.',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Explore the full documentation for each integration, or get started with TiDB Cloud free trial today.',
        image: {
          image: {
            url: 'https://static.pingcap.com/images/f2890cff-cta-cube-violet-mini.svg',
          },
