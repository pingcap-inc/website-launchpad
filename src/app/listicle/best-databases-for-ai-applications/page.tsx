...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.pingcap.com/listicle/best-databases-for-ai-applications/' },
  openGraph: {
    title: "Best Databases for AI Applications (2026) | TiDB",
    description: "Discover the top databases for AI apps in 2026. Compare TiDB, Pinecone, Weaviate, and more for RAG, vector search, and real-time data.",
    url: 'https://www.pingcap.com/listicle/best-databases-for-ai-applications/',
    siteName: 'TiDB',
    images: [
      {
...
const schema = buildPageSchema({
  path: "/listicle/best-databases-for-ai-applications/",
  title: "Best Databases for AI Applications (2026) | TiDB",
  description: "Discover the top databases for AI apps in 2026. Compare TiDB, Pinecone, Weaviate, and more for RAG, vector search, and real-time data.",
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "Best Databases for AI Applications (2026): Top Picks for RAG, Vector Search & Real-Time Data", path: "/listicle/best-databases-for-ai-applications/" },
  ],
})
...
const dsl: PageDSL = {
  ...
  "meta": {
    "title": "Best Databases for AI Applications (2026) | TiDB",
    "description": "Discover the top databases for AI apps in 2026. Compare TiDB, Pinecone, Weaviate, and more for RAG, vector search, and real-time data.",
    "canonical": "/listicle/best-databases-for-ai-applications/"
  },
  "sections": [
    {
      "id": "hero-1",
