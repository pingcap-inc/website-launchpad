  ...
  "sections": [
    ...
    },
    {
      ...
      "props": {
        ...
        "subtitle": "TiDB brings semantic search, structured filtering, and live application data together—so retrieval stays accurate, consistent, and ready for real-world AI workloads.",
        "items": [
          {
