...
export const metadata: Metadata = {
  ...
  description:
    'Unified data platform for production AI. Enable vector search, RAG, and stateful autonomous agents with live data and real-time scale.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'The Database for <span class="text-gradient-violet">Production AI</span>',
      path: '/ai/',
    },
  ],
})
  ...
  sections: [
    {
      ...
      props: {
        ...
        subheadline:
          'From grounded retrieval to stateful agents, TiDB unifies the foundation for production AI applications with live data, consistent state, and real-time scale',
        primaryCta: {
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'A single architecture that brings transactional, analytical, and AI workloads together—enabling retrieval, stateful agents, and reasoning without fragmented systems.',
        items: [
          {
            variant: 'violet',
          ...
          },
          {
            ...
            description:
              'No sync issues. No operational drag. Just a unified OLTP + OLAP + Vector engine that keeps up with your AI in real time.',
            cta: {
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'From retrieval-driven experiences to autonomous agent systems, TiDB supports the architectures teams rely on to rapidly build and operate AI at scale.',
        items: [
          {
            icon: 'Search',
            title: 'Vector Search, Retrieval, and RAG',
            description:
              'Build accurate, context-aware AI experiences using semantic search, hybrid queries, and continuously fresh data.',
            href: '/ai/vector-search/',
          },
          {
            icon: 'Bot',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Deploy AI on a trusted data platform in minutes. Start building AI with TiDB for free, or connect with our team to design systems tailored to your application.',
        image: {
          image: {
