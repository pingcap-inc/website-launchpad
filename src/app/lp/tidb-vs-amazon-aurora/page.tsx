...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.pingcap.com/tidb-vs-amazon-aurora/' },
  openGraph: {
    title: 'TiDB vs Amazon Aurora: Scale Past Instance Limits | TiDB',
    description:
      'Compare TiDB and Amazon Aurora. Scale reads and writes horizontally with strong consistency, real-time HTAP, and online schema changes—no instance ceiling.',
    url: 'https://www.pingcap.com/tidb-vs-amazon-aurora/',
    siteName: 'TiDB',
    images: [
      {
...
const schema = buildPageSchema({
  path: '/tidb-vs-amazon-aurora/',
  title: 'TiDB vs Amazon Aurora: Scale Past Instance Limits | TiDB',
  description:
    'Compare TiDB and Amazon Aurora. Scale reads and writes horizontally with strong consistency, real-time HTAP, and online schema changes—no instance ceiling.',
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: 'TiDB vs. Amazon Aurora', path: '/tidb-vs-amazon-aurora/' },
  ],
})
...
const dsl: PageDSL = {
  ...
  meta: {
    ...
    description:
      'Compare TiDB and Amazon Aurora. Scale reads and writes horizontally with strong consistency, real-time HTAP, and online schema changes—no instance ceiling.',
    canonical: '/tidb-vs-amazon-aurora/',
  },
  sections: [
    {
      id: 'hero',
      ...
      props: {
        ...
        subheadline:
          "Scale reads and writes past Aurora's instance ceiling—with strong consistency and consistent latency at any scale.",
        primaryCta: {
        ...
        items: [
          {
            ...
            title: 'Amazon Aurora',
            description:
              'Well-suited for apps with high reads up to a limit. Instance-bound writes with AWS-only deployment.',
            cta: {
              text: '',
              href: '',
            },
          ...
          },
          {
            ...
            title: 'TiDB',
            description:
              'Handles complex, data-intensive workloads in real time. Scales reads and writes horizontally without an instance ceiling.',
            cta: {
              text: '',
              href: '',
            },
        ...
        items: [
          {
            ...
            description:
              'Alter tables and add indexes in production with online DDL—no maintenance windows, no blocking migrations. Distributed replication removes single points of failure.',
            image: {
              image: {
          ...
          },
          {
            ...
            description:
              'Consolidate sharded fleets and standalone analytics systems onto one engine that scales storage and compute independently. No more paying for over-provisioned Aurora instances and bolt-on pipelines.',
            image: {
              image: {
          ...
          },
          {
            ...
            description:
              'TiFlash columnar replicas run analytics on live operational data in the same system—no ETL, no separate warehouse. Query fresh operational data without impacting transactional workloads.',
            image: {
              image: {
        ...
        items: [
          {
            ...
            a: 'TiDB is MySQL-compatible—most applications connect with no code change. We recommend validating specifics in a proof-of-concept on your own schema to ensure compatibility with your workload.',
          },
          {
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Want to see how TiDB compares to Amazon Aurora for your workload? Book a demo—our team will walk through your migration path.',
        image: {
          image: {
