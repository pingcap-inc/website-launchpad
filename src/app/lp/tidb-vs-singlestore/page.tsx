...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.pingcap.com/tidb-vs-singlestore/' },
  openGraph: {
    title: 'TiDB vs SingleStore: Open-Source Distributed SQL Comparison',
    description:
      'Compare TiDB and SingleStore for distributed SQL. TiDB offers true MySQL compatibility, open-source freedom, and elastic scaling without vendor lock-in.',
    url: 'https://www.pingcap.com/tidb-vs-singlestore/',
    siteName: 'TiDB',
    images: [
      {
  ...
  sections: [
      ...
      props: {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              'Wire-protocol compatible — your existing tools, apps, and workflows work immediately',
            cta: {
              text: 'Learn More',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'See how TiDB compares to SingleStore for your workload. Book a 30-minute architecture call with our engineering team.',
        image: {
          image: {
