  ...
  "sections": [
      ...
      "props": {
        ...
        "items": [
          ...
          },
          {
            ...
            "description": "Wire-protocol compatible, so your existing tools, apps, and workflows work immediately",
            "cta": {
              "text": "Learn More",
        ...
        "items": [
          {
            ...
            "description": "TiDB is 100% open source under an Apache 2.0 license. SingleStore's proprietary licensing creates dependency and limits deployment flexibility. You control your own roadmap with TiDB, deploy anywhere, and avoid licensing fees while still getting enterprise support when you need it.",
            "image": {
              "image": {
    ...
    },
    {
      ...
      "props": {
        ...
        "subtitle": "See how TiDB compares to SingleStore for your workload. Schedule an architecture call with our engineering team.",
        "image": {
          "image": {
