...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'TiDB vs CockroachDB: <span class="text-gradient-violet">MySQL-Compatible</span>, Native HTAP',
      path: '/lp/tidb-vs-cockroachdb/',
    },
  ],
})
  ...
  sections: [
    {
      ...
      props: {
        ...
        headline:
          'TiDB vs CockroachDB: <span class="text-gradient-violet">MySQL-Compatible</span>, Native HTAP',
        subheadline:
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'CockroachDB is Postgres-wire compatible; TiDB is MySQL-compatible. For MySQL shops, TiDB avoids the migration cost of moving to a Postgres-compatible engine.',
        items: [
          {
            variant: 'violet',
            title: 'MySQL Wire Protocol',
            description:
              'TiDB speaks MySQL 8.0 natively — use existing drivers, ORMs, and team knowledge without retraining.',
            cta: {
              text: '',
              href: '',
            },
          ...
          },
          {
            ...
            description:
              'TiFlash columnar replicas enable real-time analytics on live data. No ETL, no separate warehouse.',
            cta: {
              text: '',
              href: '',
            },
          ...
          },
          {
            ...
            description:
              'Scale compute and storage independently. Pay for what you actually need, not bundled overhead.',
            cta: {
              text: '',
              href: '',
            },
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'TiDB handles distributed database complexity so your team can focus on building features, not managing sharding logic.',
        items: [
          {
            icon: 'LayoutGrid',
            title: 'Transparent Auto-Sharding',
            description:
              'Data auto-splits into Regions and rebalances transparently across nodes. Your application never manages shard keys or partition logic. TiDB handles distribution automatically.',
            layout: 'vertical',
          },
          {
            icon: 'Layers',
            ...
            description:
              'Scale compute (TiDB nodes) and storage (TiKV/TiFlash) independently. Address the actual bottleneck without over-provisioning both layers. Pay only for what you need.',
            layout: 'vertical',
          },
          {
            icon: 'RefreshCw',
            ...
            description:
              'Schema changes run in parallel across the cluster on isolated resources. Add columns, create indexes, or modify tables without locking production traffic or scheduling downtime.',
            layout: 'vertical',
          },
          {
            icon: 'Shield',
            ...
            description:
              'Snapshot-isolation transactions coordinated by the Placement Driver provide strong consistency across all nodes. Maintain data integrity at scale without compromising on distributed guarantees.',
            layout: 'vertical',
          },
        ],
        columns: 4,
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Compare TiDB and CockroachDB on your own schema. Schedule an architecture call with our engineering team.',
        image: {
          image: {
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          "Tell us about your workload and we'll set up a 30-minute call with our engineering team. We'll walk through your data model, scaling needs, and migration path.",
        portalId: '4466002',
