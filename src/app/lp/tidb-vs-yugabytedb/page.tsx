...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.pingcap.com/tidb-vs-yugabytedb/' },
  openGraph: {
    title: 'TiDB vs YugabyteDB: MySQL-First Distributed SQL Database',
    description:
      'Compare TiDB and YugabyteDB for MySQL-first teams. TiDB offers MySQL 8.0 compatibility, native HTAP analytics, and distributed SQL at scale with lower migration friction.',
    url: 'https://www.pingcap.com/tidb-vs-yugabytedb/',
    siteName: 'TiDB',
    images: [
      {
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'TiDB vs YugabyteDB: The <span class="text-gradient-violet">MySQL-First</span> Distributed SQL',
      path: '/tidb-vs-yugabytedb/',
    },
  ],
})
  ...
  sections: [
    {
      ...
      props: {
        ...
        headline:
          'TiDB vs YugabyteDB: The <span class="text-gradient-violet">MySQL-First</span> Distributed SQL',
        subheadline:
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          'Compare TiDB and YugabyteDB on your own schema. Book a 30-minute architecture call with our engineering team.',
        image: {
          image: {
