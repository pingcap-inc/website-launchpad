...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "TiDB vs YugabyteDB: <span class=\"text-gradient-violet\">MySQL-First</span> Distributed SQL", path: "/lp/tidb-vs-yugabytedb/" },
  ],
})
  ...
  "sections": [
    {
      ...
      "props": {
        ...
        "headline": "TiDB vs YugabyteDB: <span class=\"text-gradient-violet\">MySQL-First</span> Distributed SQL",
    ...
    },
    {
      ...
      "props": {
        ...
        "subtitle": "Compare TiDB and YugabyteDB on your own schema. Schedule an architecture call with our engineering team.",
        "image": {
          "image": {
