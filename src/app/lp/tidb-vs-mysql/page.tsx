...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'TiDB vs. <span class="text-gradient-violet">MySQL</span>',
      path: '/lp/tidb-vs-mysql/',
    },
  ],
})
  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          "Schedule an architecture call with our engineering team. We'll walk through your MySQL data model, scaling needs, and migration path.",
        image: {
          image: {
