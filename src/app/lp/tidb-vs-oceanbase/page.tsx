  ...
  "sections": [
    {
      ...
      "props": {
        ...
        "subheadline": "MySQL-compatible, real-time HTAP, and compute and storage that scale independently. The distributed SQL database for teams modernizing on the cloud.",
        "primaryCta": {
        ...
        "items": [
          {
            ...
            "description": "Built for cloud-native HTAP and real-time analytics, with low-friction MySQL migration. Unifies transactions and analytics in one system.",
            "cta": {
              "text": "",
              "href": ""
            },
          ...
          },
          {
            ...
            "description": "Often chosen for financial-grade, high-concurrency OLTP and Oracle-replacement scenarios.",
            "cta": {
              "text": "",
              "href": ""
            },
    ...
    },
    {
      ...
      "props": {
        ...
        "subtitle": "See how TiDB and OceanBase compare across architecture, compatibility, and cloud-native capabilities.",
        "ourProduct": "TiDB",
        ...
        "items": [
          {
            ...
            "description": "TiDB separates compute (a stateless SQL layer) from storage (TiKV), coordinated by the Placement Driver, with optional TiFlash columnar replicas for analytics. Scale the exact bottleneck—CPU, storage, or analytics—independently.",
            "image": {
              "image": {
          ...
          },
          {
            ...
            "description": "OceanBase uses an integrated, partition-based architecture that couples compute and storage more tightly. Scaling requires coordinated partition rebalancing.",
            "image": {
              "image": {
    ...
    },
    {
      ...
      "props": {
        ...
        "subtitle": "TiFlash keeps columnar replicas and the optimizer pushes query fragments to them. One query spans row and column stores on live operational data, with no ETL.",
        "items": [
          {
            "icon": "BarChart2",
            "title": "Native Columnar Store",
            "description": "TiFlash automatically replicates data in columnar format for fast analytics."
          },
          {
            "icon": "Zap",
            "title": "No ETL Required",
            "description": "Query live operational data in real time without moving or transforming it."
          },
          {
            "icon": "Layers",
            "title": "Unified Query Engine",
            "description": "One SQL query seamlessly spans row and column stores for optimal performance."
          }
        ],
        "columns": 3,
        "borderStyle": "color"
        ...
        "items": [
          {
            ...
            "description": "Native Kubernetes operator and multi-cloud deployment flexibility for seamless orchestration.",
            "layout": "vertical"
          },
          {
            "icon": "Code2",
            "title": "Open Source",
            "description": "Control your own roadmap, not a vendor's. Contribute, customize, and extend as needed.",
            "layout": "vertical"
          },
          {
            "icon": "Database",
            "title": "MySQL Protocol & Syntax",
            "description": "Lower migration friction and tooling reuse with full MySQL compatibility.",
            "layout": "vertical"
          }
        ],
        "columns": 3,
        ...
        "items": [
          {
            ...
            "description": "Replace MySQL, Amazon Aurora, or PostgreSQL with one MySQL-compatible distributed SQL engine.",
            "image": {
              "image": {
                "url": ""
              }
          ...
          },
          {
            ...
            "description": "Eliminate Snowflake, BigQuery, or Redshift with native columnar HTAP via TiFlash—no ETL pipelines.",
            "image": {
              "image": {
                "url": ""
              }
          ...
          },
          {
            ...
            "description": "Built-in full-text and vector search replaces Elasticsearch, OpenSearch, and standalone vector databases.",
            "image": {
              "image": {
                "url": ""
              }
          ...
          },
          {
            ...
            "description": "Transparent auto-sharding with strong consistency—no app-side sharding middleware or external caches.",
            "image": {
              "image": {
                "url": ""
              }
    ...
    },
    {
      ...
      "props": {
        ...
        "subheadline": "Tell us about your workload and we'll set up a 30-minute call with our engineering team. We'll walk through your MySQL data model, scaling needs, and migration path.",
        "heroImage": {
          "image": {
            "url": "https://static.pingcap.com/images/f54533cc-1000011158.svg"
          },
