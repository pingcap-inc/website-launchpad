  ...
  sections: [
    {
      ...
      props: {
        ...
        headline:
          'One Engine. <span class="text-gradient-violet animate-glow-sweep">Not Six.</span>',
        subheadline:
          'Your stack has six databases. It could have one. Transactions, analytics, search, and vector memory in a single distributed SQL engine. MySQL-compatible, strongly consistent, and open source.',
        primaryCta: {
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          "You don't have to be a hyperscaler to have this problem. Most teams are running four or more systems long before they hit a real scale problem. That's complexity without scale, and it's real at any size.",
        items: [
          {
            icon: 'Database',
            title: 'Data Scale',
            description:
              'More data than one system can serve. The workarounds are read replicas, a bigger primary, and eventually manual sharding, at which point your application has to know where its data lives.',
          },
          {
            icon: 'LayoutGrid',
            title: 'Object Scale',
            description:
              'Too many tables and tenants to keep track of. Model each tenant as its own tables and you end up with millions of objects. This is the wall almost nobody plans for.',
          },
          {
            icon: 'Network',
            title: 'Infrastructure Sprawl',
            description:
              'A separate system for every new capability: OLTP, analytics, search, vectors, cache. Plus a pipeline between every pair of them.',
          },
        ],
        columns: 3,
        itemLayout: 'vertical',
      ...
      props: {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              'The number that matters is not how many databases you run. It is how many places your data can disagree with itself.',
            cta: {
        ...
        items: [
          {
            ...
            description:
              'Replaced nearly half a million database containers with a single TiDB Cloud instance, unifying vectors, documents, and relational data for its open-source LLM platform.',
            stats: [
              {
                value: '~500K',
          ...
          },
          {
            ...
            description:
              'Replaced hundreds of sharded PostgreSQL clusters with 16 global TiDB clusters to power its Forge platform, scaling to 3M+ tables and 500K concurrent connections per cluster.',
            stats: [
              {
                value: '3M+',
                label: 'tables per cluster',
      ...
      props: {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              'Strict ACID transactions and real joins across the cluster, not eventual consistency reconstructed in application code.',
            image: {
              image: {
          ...
          },
          {
            ...
            description:
              'Automatic failover across availability zones, with schema changes and version upgrades that run online. 99.999% availability, including planned maintenance.',
            image: {
              image: {
          ...
          },
          {
            ...
            description:
              "Full MySQL protocol and syntax, so your apps, drivers, ORMs, and your team's existing knowledge come with you.",
            image: {
              image: {
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          "A dedicated vector database or search engine will usually beat a converged engine at its one task. We'd rather tell you that here than have you discover it in a POC.",
        items: [
          {
            icon: 'Scale',
            title: 'Single Workload, Single Service',
            description:
              'If you own a single service and a single workload, a niche tool may genuinely be the better choice. Consolidation pays off when you own several.',
          },
          {
            icon: 'Target',
            title: 'When Specialist Tools Win',
            description:
              'What tips the decision is scale. Every specialized store you add is another pipeline and another consistency boundary, and past a certain point the cost of stitching them together outweighs the per-component edge.',
          },
        ],
        columns: 2,
        borderStyle: 'gray',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          "Application load used to be capped by a human population, and you could see the next ceiling coming. Agents remove the cap. They don't sleep, they spawn more agents, and they create users, writes, and objects at machine speed.",
        items: [
          {
            variant: 'teal',
            title: 'Machine-Speed Load',
            description:
              'The next bottleneck might be write throughput, tenant density, connections, or metadata, and you can no longer plan for which one it will be.',
            cta: {
          ...
          },
          {
            ...
            description:
              "An agent reading stale context doesn't slow down or ask for clarification. It acts, and chains the next several decisions off that action.",
            cta: {
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          "Spend thirty minutes with an engineer who has done this migration. We'll map your workloads, tell you which of the three walls you're closest to, and be straight with you about whether consolidating is worth it in your case.",
        image: {
          image: {
