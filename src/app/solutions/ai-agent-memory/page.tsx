  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          "Most agent platforms don't break because of bad engineering. They break because memory, state, and files were never designed to live in the same place.",
        items: [
          {
    ...
    },
    {
      ...
      props: {
        ...
        items: [
          {
            icon: 'Database',
            // title-case-ignore -- "mem9" is an intentional lowercase product name
          ...
          {
            icon: 'Layers',
            // title-case-ignore -- "drive9" is an intentional lowercase product name
