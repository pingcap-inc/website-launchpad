  ...
  "sections": [
    ...
    },
    {
      ...
      "props": {
        ...
        "subtitle": "Using a different tool for each job can work at first. The pressure shows up in production, when state has to stay in sync across systems, task outlive runtimes, and agents or tenants need their own data boundaries. ",
        "items": [
          {
            "title": "Agent State Gets Split Across Systems",
            "description": "Many agent stacks use one system for semantic search, another for session state, and another for long-lived context. This adds latency, creates more failure points, and makes it harder to debug what the agent saw and did.",
            "image": {
              "image": {
          ...
          },
          {
            ...
            "description": "Sandboxes, sessions, and processes can end while a task is still in progress. If the agent's plan, tool results, and checkpoint are not stored durably, it may repeat work, waste model spend, or fail to resume safely.",
            "image": {
              "image": {
          ...
          },
          {
            ...
            "description": "Each agent, tenant, or workspace may need its own data boundary. Running dedicated infrastructure for every environment becomes expensive as they multiply, especially when many are short-lived or mostly idle.",
            "image": {
              "image": {
      ...
      "props": {
        ...
        "items": [
          ...
          },
          {
            ...
            "description": "On TiDB Cloud, a support agent can query a customer's account tier, open tickets, and semantically similar past conversations in one SQL statement. TiFlash handles analytical queries on live data without needing a separate pipeline.",
            "cta": {
