...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.pingcap.com/solutions/best-htap-database/' },
  openGraph: {
    title: "Best HTAP Databases in 2026 - TiDB",
    description: "Compare the best htap database options for real-time analytics, OLTP, and scale. See which platforms fit hybrid workloads best.",
    url: 'https://www.pingcap.com/solutions/best-htap-database/',
    siteName: 'TiDB',
    images: [
      {
...
const schema = buildPageSchema({
  path: "/solutions/best-htap-database/",
  title: "Best HTAP Databases in 2026 - TiDB",
  description: "Compare the best htap database options for real-time analytics, OLTP, and scale. See which platforms fit hybrid workloads best.",
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "7 Best HTAP Databases for Real-Time Operational Analytics", path: "/solutions/best-htap-database/" },
  ],
})
...
const dsl: PageDSL = {
  ...
  "meta": {
    "title": "Best HTAP Databases in 2026 - TiDB",
    "description": "Compare the best htap database options for real-time analytics, OLTP, and scale. See which platforms fit hybrid workloads best.",
    "canonical": "/solutions/best-htap-database/"
  },
  "sections": [
    {
      "id": "hero-1",
