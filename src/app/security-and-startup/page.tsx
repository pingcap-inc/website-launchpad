...
export const metadata: Metadata = {
  ...
  description:
    '探索 TiDB 在阿里云上的安全架构与合规性，并了解 TiDB Cloud 初创企业支持计划。立即下载白皮书并申请初创企业权益。',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'TiDB 阿里云<span class="text-gradient-violet">安全白皮书</span>与初创企业计划',
      path: '/security-and-startup/',
    },
  ],
})
  ...
  sections: [
    {
      ...
      props: {
        ...
        subheadline:
          '获取企业级云数据库安全指南，并加入 TiDB Cloud 初创企业扶持计划，加速您的业务创新。',
        primaryCta: {
          text: '下载白皮书',
        ...
        items: [
          {
            title: '企业级安全架构',
            description:
              '白皮书详细阐述了 TiDB 在阿里云上的多层防御体系，涵盖网络隔离、数据静态与传输加密、密钥管理以及审计日志等核心安全能力，助力企业满足等保及行业合规要求。',
            image: {
              image: {
                url: '',
              },
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          '专为高潜力初创企业设计，提供技术资源、云 credits 及专家指导，助力您从零到一构建可扩展的数据基础设施。',
        items: [
          {
            icon: 'Rocket',
            title: '丰厚云资源抵扣',
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          '无论是需要深度的安全合规指导，还是寻求业务成长的资源支持，TiDB 都是您的理想伙伴。',
        image: {
          image: {
