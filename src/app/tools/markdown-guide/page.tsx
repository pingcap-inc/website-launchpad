...
const EXAMPLES: Example[] = [
  ...
  {
    id: 'section',
    title: 'Section Background (Custom Directive)',
    description:
    ...
    note: 'Attributes: `bg="light|dark|brand"` (default `light`). `light` = soft grey #f5f6f8 with default text colors. `dark` and `brand` flip headings to white. Use for standalone summary blocks; use `:::card` instead when you want a single-title card with a CTA.',
  },
  {
    id: 'cta',
