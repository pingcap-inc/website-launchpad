...
export const metadata: Metadata = {
  ...
  description: "Discover how TiDB helps you escape the MySQL sharding trap. Learn the benefits and get a clear migration path with this practical playbook.",
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "Unshard Your Future: TiDB’s Playbook for MySQL Sharding Escape", path: "/playbook/escape-mysql-sharding-pain/" },
  ],
})

const dsl: PageDSL = {
  "pageName": "Unshard Your Future: TiDB’s Playbook for MySQL Sharding Escape",
  "meta": {
    "title": "Unshard Your Future: TiDB's Playbook for Escaping MySQL",
    "description": "Discover how TiDB helps you escape the MySQL sharding trap. Learn the benefits and get a clear migration path with this practical playbook.",
  ...
  "sections": [
    {
      ...
      "props": {
        "layout": "image-right",
        "headline": "Unshard Your Future: TiDB’s Playbook for MySQL Sharding Escape",
        "heroImage": {
          "image": {
            "url": "https://static.pingcap.com/images/bc95fdfd-escape-sharding.svg",
            "alt": "escape sharding",
            "width": 397,
            "height": 417
          },
    ...
    },
    {
      ...
      "props": {
        "items": [
          ...
          {
            "id": "who-s-this-playbook-for-storage-leads-sres",
            "label": "Who’s this playbook for: Storage Leads & SREs",
            "level": 1
          },
          {
            "id": "what-we-re-solving-today-manual-mysql-sharding-chaos",
            "label": "What We’re Solving Today: Manual MySQL Sharding Chaos",
            "level": 1
          },
          {
            "id": "1-cross-shard-joins-data-silos-in-disguise",
            "label": "1. Cross-Shard Joins — Data Silos in Disguise",
            "level": 2
          },
          {
            "id": "2-re-sharding-events-the-weekend-killer",
            "label": "2. Re-Sharding Events — The Weekend-Killer",
            "level": 2
          },
          {
            "id": "3-app-side-routing-code-you-wish-you-didn-t-own",
            "label": "3. App-Side Routing — Code You Wish You Didn’t Own",
            "level": 2
          },
          {
            "id": "the-math-of-the-sharding-tax",
            "label": "The Math of the Sharding Tax",
            "level": 1
          },
          {
            "id": "diy-sharding-survival-mysql-only-tactics",
            "label": "DIY Sharding Survival: MySQL-Only Tactics",
            "level": 1
          },
          {
            "id": "design-shard-keys-guess-check-pray",
            "label": "Design Shard Keys — Guess, Check, Pray",
            "level": 2
          },
          {
            "id": "build-and-maintain-a-routing-layer",
            "label": "Build and Maintain a Routing Layer",
            "level": 2
          },
          {
            "id": "hand-craft-re-shard-pipelines",
            "label": "Hand-Craft Re-Shard Pipelines",
            "level": 2
          },
          {
            "id": "chase-cross-shard-consistency",
            "label": "Chase Cross-Shard Consistency",
            "level": 2
          },
          {
            "id": "make-it-easier-on-yourself-with-tidb-s-anti-sharding-architecture",
            "label": "Make it Easier on Yourself with TiDB’s Anti-Sharding Architecture",
            "level": 1
          },
          {
            "id": "distributed-sql-that-speaks-mysql",
            "label": "Distributed SQL That Speaks MySQL",
            "level": 2
          },
          {
            "id": "online-auto-scaling-no-re-shard-required",
            "label": "Online Auto-Scaling—No Re-Shard Required",
            "level": 2
          },
          {
            "id": "global-acid-transactions-across-every-shard",
            "label": "Global ACID Transactions Across Every Shard",
            "level": 2
          },
          {
            "id": "how-tidb-eliminates-manual-sharding",
            "label": "How TiDB Eliminates Manual Sharding",
            "level": 1
          },
          {
            "id": "tooling-for-the-transition",
            "label": "Tooling for the Transition",
            "level": 2
          },
          {
            "id": "step-by-step-migration-guide",
            "label": "Step-by-Step Migration Guide",
            "level": 1
          },
          {
            "id": "map-your-shard-topology",
            "label": "Map Your Shard Topology",
            "level": 2
          },
          {
            "id": "move-data-with-dumpling-import-into-and-tidb-lightning",
            "label": "Move Data with Dumpling, IMPORT INTO, and TiDB Lightning",
            "level": 2
          },
          {
            "id": "cutover-validate-optimize",
            "label": "Cutover, Validate, Optimize",
            "level": 2
          },
          {
          ...
          {
            "id": "observe-alert-with-tidb-dashboard",
            "label": "Observe & Alert with TiDB Dashboard",
            "level": 2
          },
          {
            "id": "backup-restore-shards-optional",
            "label": "Backup & Restore—Shards Optional",
            "level": 2
          },
          {
            "id": "elastic-scale-cost-guardrails",
            "label": "Elastic Scale & Cost Guardrails",
            "level": 2
          },
          {
          ...
          {
            "id": "flipkart-1m-qps-with-zero-downtime-maintenance",
            "label": "Flipkart: 1M+ QPS with Zero-Downtime Maintenance",
            "level": 2
          },
          {
            "id": "outcomes",
          ...
          {
            "id": "bolt-modernizing-mysql-to-scale-thousands-of-microservices-on-aws",
            "label": "Bolt: Modernizing MySQL to Scale Thousands of Microservices on AWS",
            "level": 2
          },
          {
            "id": "next-steps",
          ...
          {
            "id": "book-a-data-model-workshop",
            "label": "Book a Data-Model Workshop",
            "level": 2
          }
        ],
        "sticky": true
