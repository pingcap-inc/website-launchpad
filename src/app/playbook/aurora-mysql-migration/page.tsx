...
export const metadata: Metadata = {
  ...
  description:
    'Hit Aurora’s limits? Migrate to TiDB— a distributed SQL database for MySQL horizontal scaling, higher write throughput, and simpler HA. Start your migration.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'Aurora MySQL Migration: Scale Writes, Ditch Limits',
      path: '/playbook/aurora-mysql-migration/',
    },
  ],
})
