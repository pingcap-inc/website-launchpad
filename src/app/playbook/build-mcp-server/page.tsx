...
export const metadata: Metadata = {
  title: "TiDB | How to Build an MCP Server with TiDB Cloud Zero",
  description: "**Updated August 2026 | Author: Brian Foster (Content Director) | Reviewed by: Bosn Ma (Director of Engineering, Cloud & AI Products)**",
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "How to Build an MCP Server with TiDB Cloud Zero", path: "/playbook/build-mcp-server/" },
  ],
})
...
const dsl: PageDSL = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Give your MCP server a real SQL backend in seconds. No sign-up, no config, claim it when it works.",
        "primaryCta": {
