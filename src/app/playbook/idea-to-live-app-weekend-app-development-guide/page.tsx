...
export const metadata: Metadata = {
  ...
  description:
    'A weekend-ready AI app development guide. Go from idea to live app with agents, RAG, vector search, and TiDB Cloud on Kubernetes.',
  robots: { index: true, follow: true },
  alternates: {
    canonical: 'https://www.pingcap.com/playbook/idea-to-live-app-weekend-app-development-guide/',
  },
  openGraph: {
    title: 'From Idea to Live App in a Weekend: AI App Development Guide',
    description:
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'From Idea to Live App in a Weekend',
      path: '/playbook/idea-to-live-app-weekend-app-development-guide/',
    },
  ],
})
