...
export const metadata: Metadata = {
  ...
  description: "Learn how ai agent memory works across working, short-term, and long-term memory, plus the architecture choices behind retrieval and state.",
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "AI Agent Memory Architecture: How to Store Long-Term Memory, State, and Retrieval Data", path: "/playbook/ai-agent-memory/" },
  ],
})

const dsl: PageDSL = {
  "pageName": "AI Agent Memory Architecture: How to Store Long-Term Memory, State, and Retrieval Data",
  "meta": {
    "title": "AI Agent Memory Architecture Guide - TiDB",
    "description": "Learn how ai agent memory works across working, short-term, and long-term memory, plus the architecture choices behind retrieval and state.",
  ...
  "sections": [
    {
      ...
      "props": {
        "layout": "image-right",
        "headline": "AI Agent Memory Architecture: How to Store Long-Term Memory, State, and Retrieval Data",
        "heroImage": {
          "image": {
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Build agent memory on a database with SQL, vector search, and elastic scale in one engine.",
        "primaryCta": {
