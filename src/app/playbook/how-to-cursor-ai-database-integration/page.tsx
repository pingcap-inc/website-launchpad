...
export const metadata: Metadata = {
  title: "Cursor AI Database Integration with TiDB",
  description: "Connect TiDB to Cursor for faster SQL, schema exploration, and AI coding. Show the exact setup path, common issues, and where TiDB fits best.",
  robots: { index: true, follow: true },
  alternates: { canonical: 'https://www.pingcap.com/playbook/how-to-cursor-ai-database-integration/' },
  openGraph: {
    title: "Cursor AI Database Integration with TiDB",
    description: "Connect TiDB to Cursor for faster SQL, schema exploration, and AI coding. Show the exact setup path, common issues, and where TiDB fits best.",
    url: 'https://www.pingcap.com/playbook/how-to-cursor-ai-database-integration/',
    siteName: 'TiDB',
    images: [
      {
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "How to connect TiDB to Cursor for AI-assisted app development", path: "/playbook/how-to-cursor-ai-database-integration/" },
  ],
})

const dsl: PageDSL = {
  "pageName": "How to connect TiDB to Cursor for AI-assisted app development",
  "meta": {
    "title": "Cursor AI Database Integration with TiDB",
    "description": "Connect TiDB to Cursor for faster SQL, schema exploration, and AI coding. Show the exact setup path, common issues, and where TiDB fits best.",
    "canonical": "/playbook/how-to-cursor-ai-database-integration/"
  },
  "sections": [
    {
      "id": "hero-1",
    ...
    },
    {
      ...
      "props": {
        "items": [
          ...
          {
            "id": "how-to-connect-tidb-to-cursor",
            "label": "How to connect TiDB to Cursor",
            "level": 1
          },
          {
            "id": "set-up-tidb-cloud-access-for-cursor",
            "label": "Set up TiDB Cloud access for Cursor",
            "level": 2
          },
          {
            "id": "add-tidb-mcp-server-to-cursor",
            "label": "Add TiDB MCP Server to Cursor",
            "level": 2
          },
          {
            "id": "test-schema-access-and-run-a-first-query",
            "label": "Test schema access and run a first query",
            "level": 2
          },
          {
            "id": "what-do-you-need-before-cursor-can-access-your-database",
            "label": "What do you need before Cursor can access your database?",
            "level": 1
          },
          {
            "id": "how-cursor-ai-database-integration-works-with-mcp",
            "label": "How Cursor AI database integration works with MCP",
            "level": 1
          },
          {
            "id": "why-mcp-is-better-than-pasting-schema-by-hand",
            "label": "Why MCP is better than pasting schema by hand",
            "level": 2
          },
          {
            "id": "where-tidb-fits-in-an-ai-coding-workflow",
            "label": "Where TiDB fits in an AI coding workflow",
            "level": 2
          },
          {
            "id": "how-to-use-tidb-and-cursor-for-real-app-development",
            "label": "How to use TiDB and Cursor for real app development",
            "level": 1
          },
          {
            "id": "generate-sql-with-live-schema-context",
            "label": "Generate SQL with live schema context",
            "level": 2
          },
          {
            "id": "debug-backend-code-faster-with-database-access",
            "label": "Debug backend code faster with database access",
            "level": 2
          },
          {
            "id": "review-ai-output-before-production-use",
            "label": "Review AI output before production use",
            "level": 2
          },
          {
            "id": "checklist-for-a-safe-and-reliable-cursor-database-connection",
            "label": "Checklist for a safe and reliable Cursor database connection",
            "level": 1
          },
          {
            "id": "how-to-troubleshoot-tidb-and-cursor-integration-issues",
            "label": "How to troubleshoot TiDB and Cursor integration issues",
            "level": 1
          },
          {
            "id": "fix-authentication-and-permission-errors",
            "label": "Fix authentication and permission errors",
            "level": 2
          },
          {
            "id": "resolve-mcp-server-and-dependency-issues",
            "label": "Resolve MCP server and dependency issues",
            "level": 2
          },
          {
            "id": "check-trust-settings-and-security-controls",
            "label": "Check trust settings and security controls",
            "level": 2
          },
          {
            "id": "how-tidb-helps-cursor-work-better-with-live-data",
            "label": "How TiDB helps Cursor work better with live data",
            "level": 1
          },
          {
            "id": "why-tidb-is-a-strong-fit-for-ai-assisted-app-development",
            "label": "Why TiDB is a strong fit for AI-assisted app development",
            "level": 2
          },
          {
            "id": "build-ai-applications-on-tidb",
            "label": "Build AI applications on TiDB",
            "level": 1
          },
          {
            "id": "cursor-ai-database-integration-faqs",
            "label": "Cursor AI database integration FAQs",
            "level": 1
          },
          {
            "id": "can-cursor-connect-to-tidb-directly",
            "label": "Can Cursor connect to TiDB directly?",
            "level": 2
          },
          {
            "id": "what-is-mcp-in-cursor",
            "label": "What is MCP in Cursor?",
            "level": 2
          },
          {
            "id": "is-it-safe-to-give-cursor-access-to-a-live-database",
            "label": "Is it safe to give Cursor access to a live database?",
            "level": 2
          },
          {
            "id": "how-long-does-it-take-to-connect-tidb-to-cursor",
            "label": "How long does it take to connect TiDB to Cursor?",
            "level": 2
          },
          {
            "id": "can-cursor-help-write-sql-for-tidb",
            "label": "Can Cursor help write SQL for TiDB?",
            "level": 2
          }
        ],
        "sticky": true
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Start a free TiDB Cloud Starter cluster and connect to Cursor in under 30 minutes.",
        "primaryCta": {
          "text": "Start for Free",
          "href": "https://www.pingcap.com/ai/"
        },
        "secondaryCta": {
          "text": "TiDB Integrations",
          "href": "https://www.pingcap.com/integrations/"
        }
      },
      "style": {
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "TiDB's official MCP server is maintained against current Cursor releases. Test the integration against your own schema.",
        "primaryCta": {
          "text": "Start for Free",
          "href": "https://www.pingcap.com/ai/"
        },
        "secondaryCta": {
          "text": "Cursor + TiDB Setup Guide",
          "href": "https://docs.pingcap.com/ai/tidb-mcp-cursor/"
        }
      },
      "style": {
        "background": "brand-violet",
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Ready to connect TiDB to Cursor? Start a free cluster in under 5 minutes.",
        "primaryCta": {
          "text": "Start for Free — TiDB Cloud Starter",
          "href": "https://www.pingcap.com/ai/"
        },
        "secondaryCta": {
          "text": "Read the TiDB MCP Server Docs",
          "href": "https://docs.pingcap.com/ai/tidb-mcp-cursor/"
        }
      },
      "style": {
