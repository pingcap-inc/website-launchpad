...
export const metadata: Metadata = {
  ...
  description:
    'Connect TiDB to Cursor for faster SQL, schema exploration, and AI coding. Show the exact setup path, common issues, and where TiDB fits best.',
  robots: { index: true, follow: true },
  alternates: {
    canonical: 'https://www.pingcap.com/playbook/how-to-cursor-ai-database-integration/',
  },
  openGraph: {
    title: 'Cursor AI Database Integration with TiDB',
    description:
