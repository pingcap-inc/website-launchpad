      ...
      "props": {
        ...
        "items": [
          ...
          },
          {
            ...
            "description": "AI coding assistants can generate an app quickly, but keeping it reliable as usage grows takes planning. This playbook covers how to scope, build, and deploy a live AI app in one weekend, with practical guidance on tool calling, RAG, vector search, production guardrails, and using TiDB Cloud to keep application data and embeddings in one scalable database.",
            "cta": {
              "text": "Read the Playbook",
              "href": "pingcap.com/playbook/idea-to-live-app-weekend-app-development-guide/"
            },
            "layout": "vertical"
          }
        ],
