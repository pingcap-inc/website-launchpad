      ...
      props: {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              'AI coding assistants hallucinate schema. MCP fixes that by giving Cursor live access to your tables, types, and relationships before it generates a query. This covers the full setup path for TiDB, the trust model, and what to review before any generated SQL touches production.',
            cta: {
              text: 'Read the Playbook',
          ...
          {
            icon: 'FileCode',
            title: 'From Idea to Live App in a Weekend',
            description:
              'AI coding assistants can generate an app quickly, but keeping it reliable as usage grows takes planning. This playbook covers how to scope, build, and deploy a live AI app in one weekend, with practical guidance on tool calling, RAG, vector search, production guardrails, and using TiDB Cloud to keep application data and embeddings in one scalable database.',
            cta: {
              text: 'Read the Playbook',
              href: '/playbook/idea-to-live-app-weekend-app-development-guide/',
            },
            layout: 'vertical',
          },
        ],
