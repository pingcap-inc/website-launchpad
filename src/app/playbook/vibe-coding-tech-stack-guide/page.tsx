...
export const metadata: Metadata = {
  ...
  description:
    'Build faster in 2026 with a proven vibe coding tech stack. See tools, Next.js and TypeScript patterns, and why TiDB Cloud fits AI apps at scale.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'The Complete Vibe Coding Tech Stack in 2026: What You Actually Need',
      path: '/playbook/vibe-coding-tech-stack-guide/',
    },
  ],
})
  ...
  sections: [
    {
      ...
      props: {
        ...
        heroImage: {
          image: {
            url: 'https://static.pingcap.com/images/83d200e7-_____.png',
            width: 934,
            height: 664,
          },
          alt: '',
