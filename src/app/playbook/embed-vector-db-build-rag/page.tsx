...
export const metadata: Metadata = {
  ...
  description: "Compare TiDB's embedded vector DB approach against the classic two-DB setup for RAG. Discover how TiDB unifies vector and SQL in one system.",
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "RAG Without Extra Luggage: TiDB’s Embedded Vector DB", path: "/playbook/embed-vector-db-build-rag/" },
  ],
})

const dsl: PageDSL = {
  "pageName": "RAG Without Extra Luggage: TiDB’s Embedded Vector DB",
  "meta": {
    "title": "TiDB vs Pinecone: RAG Stack Simplified | TiDB",
    "description": "Compare TiDB's embedded vector DB approach against the classic two-DB setup for RAG. Discover how TiDB unifies vector and SQL in one system.",
  ...
  "sections": [
    {
      ...
      "props": {
        "layout": "image-right",
        "headline": "RAG Without Extra Luggage: TiDB’s Embedded Vector DB",
        "heroImage": {
          "image": {
            "url": "https://static.pingcap.com/images/80f03bdf-rag-without-extra-luggage.svg",
            "alt": "rag without extra luggage",
            "width": 421,
            "height": 447
          },
          "alt": "rag without extra luggage",
    ...
    },
    {
      ...
      "props": {
        "items": [
          ...
          {
            "id": "who-is-this-playbook-for-storage-leads-sres-ai-startup-developers",
            "label": "Who is This Playbook for: Storage Leads, SREs, & AI Startup Developers",
            "level": 1
          },
          {
            "id": "pain-rag-needs-extra-vector-db-deeds",
            "label": "Pain: RAG Needs, Extra Vector DB Deeds",
            "level": 1
          },
          {
            "id": "two-databases-double-trouble",
            "label": "Two Databases, Double Trouble",
            "level": 2
          },
          {
            "id": "sync-drift-latency-spikes",
            "label": "Sync Drift & Latency Spikes",
            "level": 2
          },
          {
            "id": "diy-route-standalone-vector-store-ops-the-two-db-tango",
            "label": "DIY Route: Standalone Vector Store Ops (The Two-DB Tango)",
            "level": 1
          },
          {
            "id": "deploy-etl-monitor-repeat",
            "label": "Deploy, ETL, Monitor, Repeat",
            "level": 2
          },
          {
            "id": "hybrid-queries-in-app-code",
            "label": "Hybrid Queries in App Code",
            "level": 2
          },
          {
            "id": "tidb-route-embedded-vector-db-power",
            "label": "TiDB Route: Embedded Vector DB Power",
            "level": 1
          },
          {
            "id": "vector-columns-beside-rows",
            "label": "Vector Columns Beside Rows",
            "level": 2
          },
          {
            "id": "hybrid-similarity-sql-joins",
            "label": "Hybrid Similarity + SQL Joins",
            "level": 2
          },
          {
            "id": "labor-showdown-ops-hours-incidents-count",
            "label": "Labor Showdown: Ops Hours & Incidents Count",
            "level": 1
          },
          {
          ...
          {
            "id": "upgrade-ingest-query-tune",
            "label": "Upgrade, Ingest, Query, Tune",
            "level": 2
          },
          {
          ...
          {
            "id": "vector-aware-metrics-in-tidb-dashboard",
            "label": "Vector-Aware Metrics in TiDB Dashboard",
            "level": 2
          },
          {
            "id": "online-re-indexing-auto-scaling-recommendations",
            "label": "Online Re-Indexing & Auto-Scaling Recommendations",
            "level": 2
          },
          {
            "id": "full-cluster-backup-including-vector-data",
            "label": "Full-Cluster Backup Including Vector Data",
            "level": 2
          },
          {
          ...
          {
            "id": "new-retail-giant-45-lower-costs-with-a-graphrag-knowledge-system",
            "label": "New Retail Giant: 45% Lower Costs with a GraphRAG Knowledge System",
            "level": 2
          },
          {
            "id": "outcomes",
          ...
          {
            "id": "innovative-saas-company-real-time-customer-feedback-intelligence-with-tidb-ai",
            "label": "Innovative SaaS Company: Real-Time Customer Feedback Intelligence with TiDB \\+ AI",
            "level": 2
          },
          {
            "id": "next-steps",
          ...
          {
            "id": "spin-up-a-free-tidb-cloud-vector-sandbox",
            "label": "Spin Up a Free TiDB Cloud Vector Sandbox",
            "level": 2
          },
          {
            "id": "schedule-an-embedded-vector-db-architecture-workshop",
            "label": "Schedule an Embedded Vector DB Architecture Workshop",
            "level": 2
          }
        ],
        "sticky": true
