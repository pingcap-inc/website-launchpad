  ...
  en: {
    ...
    ecosystem: {
      ...
      paragraphs: [
        ...
        'Work with regional partners, such as AI/R, Derevo, Overlabs, SoftwareOne, CloudContinuity, and BigCheese.',
  ...
  es: {
    ...
    ecosystem: {
      ...
      paragraphs: [
        ...
        'Trabaja con socios regionales, como AI/R, Derevo, Overlabs, SoftwareOne, CloudContinuity y BigCheese.',
  ...
  pt: {
    ...
    ecosystem: {
      ...
      paragraphs: [
        ...
        'Trabalhe com parceiros regionais, como AI/R, Derevo, Overlabs, SoftwareOne, CloudContinuity e BigCheese.',
