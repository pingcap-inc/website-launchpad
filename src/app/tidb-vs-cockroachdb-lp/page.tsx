...
export const metadata: Metadata = {
  ...
  description:
    'Compare TiDB and CockroachDB for MySQL workloads. TiDB offers MySQL compatibility, native columnar HTAP with TiFlash, and disaggregated compute/storage scaling without Postgres migration costs.',
