...
export const metadata: Metadata = {
  title: 'TiDB vs MySQL 2026: a Comparison Guide for Platform Teams',
  description:
    "Compare TiDB and MySQL 2026 for scalable database performance and features. Find out which is better for your platform team's needs.",
  robots: { index: true, follow: true },
  alternates: { canonical: 'https://www.pingcap.com/compare/mysql-vs-tidb/' },
  openGraph: {
    title: 'TiDB vs MySQL 2026: a Comparison Guide for Platform Teams',
    description:
      "Compare TiDB and MySQL 2026 for scalable database performance and features. Find out which is better for your platform team's needs.",
    url: 'https://www.pingcap.com/compare/mysql-vs-tidb/',
    siteName: 'TiDB',
    images: [
      {
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'TiDB vs MySQL (2026) Comparison Guide for Platform Teams',
      path: '/compare/mysql-vs-tidb/',
    },
  ],
})
...
const dsl: PageDSL = {
  pageName: 'TiDB vs MySQL (2026) Comparison Guide for Platform Teams',
  meta: {
    title: 'TiDB vs MySQL 2026: a Comparison Guide for Platform Teams',
    description:
      "Compare TiDB and MySQL 2026 for scalable database performance and features. Find out which is better for your platform team's needs.",
    canonical: '/compare/mysql-vs-tidb/',
  },
  sections: [
    {
      id: 'hero-1',
      ...
      props: {
        layout: 'image-right',
        headline: 'TiDB vs MySQL (2026) Comparison Guide for Platform Teams',
        heroImage: {
          image: {
            url: 'https://static.pingcap.com/images/e30c09ce-tidb-vs-mysql.svg',
            alt: 'tidb vs mysql',
            width: 591,
            height: 450,
          },
    ...
    },
    {
      ...
      props: {
        items: [
          ...
          {
            id: 'tidb-vs-mysql-side-by-side-comparison-table',
            label: 'TiDB vs MySQL: Side-by-Side Comparison Table',
            level: 1,
          },
          {
            id: 'tidb-vs-mysql-overview-quick-take',
            label: 'TiDB vs MySQL Overview (Quick Take)',
            level: 1,
          },
          {
            id: 'tidb-in-brief-distributed-sql-newsql-htap-database',
            label: 'TiDB in Brief: Distributed SQL + NewSQL + HTAP Database',
            level: 2,
          },
          {
            id: 'mysql-in-brief-why-it-s-great-and-where-mysql-scalability-breaks',
            label: 'MySQL in Brief: Why It’s Great—and Where MySQL Scalability Breaks',
            level: 2,
          },
          {
          ...
          {
            id: 'key-differences-when-tidb-wins-vs-when-mysql-wins',
            label: 'Key Differences: When TiDB Wins vs When MySQL Wins',
            level: 1,
          },
          {
            id: 'no-manual-mysql-sharding-elastic-scale-out',
            label: 'No Manual MySQL Sharding (Elastic Scale-Out)',
            level: 2,
          },
          {
            id: 'acid-transactions-distributed-transactions-at-scale',
            label: 'ACID Transactions + Distributed Transactions at Scale',
            level: 2,
          },
          {
            id: 'htap-analytics-with-tiflash-fresh-oltp-data',
            label: 'HTAP Analytics with TiFlash (Fresh OLTP Data)',
            level: 2,
          },
          {
            id: 'high-availability-database-point-in-time-recovery-pitr',
            label: 'High Availability Database + Point-in-Time Recovery (PITR)',
            level: 2,
          },
          {
            id: 'cloud-native-database-operations-on-kubernetes',
            label: 'Cloud-Native Database Operations on Kubernetes',
            level: 2,
          },
          {
            id: 'architecture-how-tidb-scales-beyond-single-node-mysql',
            label: 'Architecture: How TiDB Scales Beyond Single-Node MySQL',
            level: 1,
          },
          {
            id: 'tidb-tikv-tiflash-and-placement-driver-the-htap-architecture-in-plain-english',
            label:
              'TiDB, TiKV, TiFlash, and Placement Driver: the HTAP Architecture in Plain English',
            level: 2,
          },
          {
            id: 'automatic-sharding-and-database-partitioning-what-you-manage-vs-tidb',
            label: 'Automatic Sharding and Database Partitioning (What You Manage vs TiDB)',
            level: 2,
          },
          {
            id: 'mysql-compatibility-and-key-limitations-to-validate',
            label: 'MySQL Compatibility (and Key Limitations to Validate)',
            level: 1,
          },
          {
            id: 'protocol-syntax-drivers-and-orm-surface-area',
            label: 'Protocol, Syntax, Drivers, and ORM Surface Area',
            level: 2,
          },
          {
            id: 'poc-checklist-query-patterns-and-sql-features-to-test',
            label: 'POC Checklist: Query Patterns and SQL Features to Test',
            level: 2,
          },
          {
            id: 'consistency-transactions-acid-compliance-in-a-distributed-sql-database',
            label: 'Consistency & Transactions: ACID Compliance in a Distributed SQL Database',
            level: 1,
          },
          {
            id: 'acid-transactions-what-stays-the-same-vs-mysql',
            label: 'ACID Transactions: What Stays the Same vs MySQL',
            level: 2,
          },
          {
            id: 'distributed-transactions-latency-and-tradeoffs-to-understand',
            label: 'Distributed Transactions: Latency and Tradeoffs to Understand',
            level: 2,
          },
          {
            id: 'scaling-performance-mysql-scalability-vs-horizontal-scaling-in-tidb',
            label: 'Scaling & Performance: MySQL Scalability vs Horizontal Scaling in TiDB',
            level: 1,
          },
          {
            id: 'oltp-at-scale-add-nodes-instead-of-bigger-boxes',
            label: 'OLTP at Scale: Add Nodes Instead of Bigger Boxes',
            level: 2,
          },
          {
            id: 'mysql-sharding-vs-tidb-auto-sharding-operational-overhead-comparison',
            label: 'MySQL Sharding vs TiDB Auto-Sharding: Operational Overhead Comparison',
            level: 2,
          },
          {
            id: 'htap-analytics-oltp-vs-olap-without-a-separate-warehouse',
            label: 'HTAP Analytics: OLTP vs OLAP Without a Separate Warehouse',
            level: 1,
          },
          {
            id: 'what-htap-means-and-when-it-matters',
            label: 'What HTAP Means (and When It Matters)',
            level: 2,
          },
          {
            id: 'tiflash-columnar-replicas-for-real-time-analytics',
            label: 'TiFlash: Columnar Replicas for Real-Time Analytics',
            level: 2,
          },
          {
            id: 'multi-region-locality-what-s-realistic-for-writes-and-reads',
            label: 'Multi-Region & Locality: What’s Realistic for Writes and Reads',
            level: 1,
          },
          {
            id: 'single-region-ha-vs-multi-region-reads-vs-multi-region-writes',
            label: 'Single-Region HA vs Multi-Region Reads vs Multi-Region Writes',
            level: 2,
          },
          {
            id: 'operations-reliability-ha-backups-and-pitr',
            label: 'Operations & Reliability: HA, Backups, and PITR',
            level: 1,
          },
          {
            id: 'high-availability-database-behavior-during-az-failures',
            label: 'High Availability Database Behavior During AZ Failures',
            level: 2,
          },
          {
            id: 'point-in-time-recovery-pitr-what-it-is-and-why-it-matters',
            label: 'Point-in-Time Recovery (PITR): What It Is and Why It Matters',
            level: 2,
          },
          {
            id: 'enterprise-grade-security-encryption-in-transit-at-rest',
            label: 'Enterprise-Grade Security (Encryption in Transit/At Rest)',
            level: 2,
          },
          {
            id: 'ecosystem-integrations-kubernetes-cdc-and-observability',
            label: 'Ecosystem & Integrations: Kubernetes, CDC, and Observability',
            level: 1,
          },
          {
            id: 'kubernetes-database-operator-deploy-scale-upgrade-with-confidence',
            label: 'Kubernetes Database Operator: Deploy, Scale, Upgrade with Confidence',
            level: 2,
          },
          {
            id: 'cdc-pipelines-and-streaming-integrations-operational-analytics',
            label: 'CDC Pipelines and Streaming Integrations (Operational + Analytics)',
            level: 2,
          },
          {
            id: 'observability-integrations',
            label: 'Observability Integrations',
            level: 2,
          },
          {
            id: 'implementation-migration-moving-from-mysql-to-tidb',
            label: 'Implementation & Migration: Moving from MySQL to TiDB',
            level: 1,
          },
          {
            id: 'step-1-schema-compatibility-assessment',
            label: 'Step 1: Schema + Compatibility Assessment',
            level: 2,
          },
          {
            id: 'step-2-data-migration-validation',
            label: 'Step 2: Data Migration + Validation',
            level: 2,
          },
          {
            id: 'step-3-cutover-strategy-dual-write-vs-controlled-switchover',
            label: 'Step 3: Cutover Strategy (Dual-Write vs Controlled Switchover)',
            level: 2,
          },
          {
            id: 'pricing-tidb-cloud-vs-self-managed-tco',
            label: 'Pricing: TiDB Cloud vs Self-Managed TCO',
            level: 1,
          },
          {
            id: 'cost-drivers-to-compare-compute-storage-backups-egress-support',
            label: 'Cost Drivers to Compare (Compute, Storage, Backups, Egress, Support)',
            level: 2,
          },
          {
            id: 'pros-cons-tidb-and-mysql',
            label: 'Pros & Cons: TiDB and MySQL',
            level: 1,
          },
          {
            id: 'tidb-pros-for-scale-out-oltp-htap',
            label: 'TiDB Pros for Scale-Out OLTP + HTAP',
            level: 2,
          },
          {
            id: 'tidb-tradeoffs-to-validate-in-your-workload',
            label: 'TiDB Tradeoffs to Validate in Your Workload',
            level: 2,
          },
          {
            id: 'mysql-pros-and-constraints-at-scale',
            label: 'MySQL Pros and Constraints at Scale',
            level: 2,
          },
          {
            id: 'who-should-choose-tidb-vs-mysql',
            label: 'Who Should Choose TiDB vs MySQL?',
            level: 1,
          },
          {
            id: 'choose-tidb-if-you-need-scale-out-acid-htap',
            label: 'Choose TiDB if You Need Scale-Out + ACID + HTAP',
            level: 2,
          },
          {
            id: 'choose-mysql-if-your-workloads-fit-single-node-simpler-ops',
            label: 'Choose MySQL if Your Workloads Fit Single-Node + Simpler Ops',
            level: 2,
          },
          {
            id: 'faq',
            label: 'FAQs: TiDB vs MySQL',
            level: 1,
          },
          {
            id: 'proof-deeper-dives',
            label: 'Proof & Deeper Dives',
            level: 1,
          },
        ],
        sticky: true,
    ...
    },
    {
      ...
      type: 'faq',
      props: {
        title: 'FAQs: TiDB vs MySQL',
        items: [
          {
            q: 'What is the difference between MySQL and TiDB?',
            a: 'MySQL is a traditional relational database commonly deployed as a single primary with replicas. TiDB is a Distributed SQL database designed for horizontal scaling with TiKV storage and optional HTAP analytics using TiFlash.',
          },
          {
            q: 'Is TiDB a drop-in replacement for MySQL?',
            a: 'TiDB is MySQL-compatible at the protocol level and supports common syntax, but you should validate compatibility differences and workload behavior in a POC.',
          },
          {
            q: 'Is TiDB NoSQL?',
            a: 'No. TiDB is a Distributed SQL database that supports SQL and ACID transactions.',
          },
          {
            q: 'Which companies use TiDB?',
            a: '(Reference the “Trusted by Innovation Leaders” logo strip and link to relevant customer stories.)',
          },
          {
            q: 'How scalable is TiDB compared to MySQL?',
            a: 'TiDB is designed to scale horizontally by adding nodes, while MySQL commonly scales reads via replicas and often requires architectural changes to scale writes beyond a single primary.',
          },
        ],
      },
      style: {
    ...
    },
    {
      ...
      props: {
        content:
          '## Proof & Deeper Dives\n\n* Customer stories (keep existing links)  \n* Webinar (keep existing link)  \n* Blog posts (keep existing links)',
        className: 'rich-text-block--raw-source',
      },
      style: {
        background: 'none',
