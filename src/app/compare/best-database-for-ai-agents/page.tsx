...
const dsl: PageDSL = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "props": {
        "items": [
          ...
          {
            "id": "what-we-compared-memory-layers-vector-search-acid-scale-ops-complexity",
            "label": "What We Compared (Memory Layers, Vector Search, ACID, Scale, Ops Complexity)",
            "level": 2
          },
          {
            "id": "how-to-read-this-table-match-your-agent-s-storage-needs-first",
            "label": "How to Read This Table (Match Your Agent's Storage Needs First)",
            "level": 2
          },
          {
          ...
          {
            "id": "two-common-architectures-for-agent-memory-and-when-each-wins",
            "label": "Two Common Architectures for Agent Memory (and When Each Wins)",
            "level": 2
          },
          {
          ...
          {
            "id": "agent-memory-coverage",
            "label": "Agent Memory Coverage",
            "level": 2
          },
          {
            "id": "vector-search-quality",
            "label": "Vector Search Quality",
            "level": 2
          },
          {
            "id": "acid-compliance",
          ...
          },
          {
            ...
            "label": "Security & Enterprise Readiness",
            "level": 2
          },
          {
          ...
          {
            "id": "try-tidb-cloud-for-ai-agents",
            "label": "Try TiDB Cloud for AI Agents",
            "level": 1
          },
          {
            "id": "explore-ai-demos-and-tutorials",
            "label": "Explore AI Demos and Tutorials",
            "level": 1
          },
          {
            "id": "read-the-agentic-ai-database-trends-report",
            "label": "Read the Agentic AI Database Trends Report",
            "level": 1
          }
        ],
        "sticky": true
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Ready to build your AI agent data layer? Spin up a free TiDB Cloud cluster in under two minutes — no credit card required.",
        "primaryCta": {
          "text": "Start for Free",
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Migrating from sharded MySQL or a multi-database agent stack? Our team can review your schema and access patterns on a free 30-minute call.",
        "primaryCta": {
          "text": "Talk to an Engineer",
          "href": "https://www.pingcap.com/contact-us/"
        },
        "secondaryCta": {
          "text": "See Migration Guide",
    ...
    },
    {
      ...
      "type": "richTextBlock",
      "props": {
        "content": "## Next Steps: Build Your AI Agent Data Layer with TiDB\n\n:::card\n## Try TiDB Cloud for AI Agents\n\n[Learn More](https://www.pingcap.com/tidb/cloud/)\n:::\n\n:::card\n## Explore AI Demos and Tutorials\n\n[Explore](https://www.pingcap.com/ai/)\n:::\n\n:::card\n## Read the Agentic AI Database Trends Report\n\n[Learn More](https://www.pingcap.com/blog/agentic-ai-database-trends-that-will-define-2026/)\n:::",
        "className": "rich-text-block--raw-source"
      },
      "style": {
        "background": "none",
