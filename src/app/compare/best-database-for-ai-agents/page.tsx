...
export const metadata: Metadata = {
  ...
  description:
    'Discover the best databases for AI agents in 2026 , comparing options for memory layers, vector search, ACID, and scalability.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'Best Database for AI Agents (2026): Memory, State & RAG Guide',
      path: '/compare/best-database-for-ai-agents/',
    },
  ],
})
  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'Ready to build your AI agent data layer? Spin up a free TiDB Cloud cluster in under two minutes — no credit card required.',
        primaryCta: {
          text: 'Start for Free',
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'Migrating from sharded MySQL or a multi-database agent stack? Our team can review your schema and access patterns on a free 30-minute call.',
        primaryCta: {
