...
export const metadata: Metadata = {
  ...
  description:
    'Compare the best htap database options for real-time analytics, OLTP, and scale. See which platforms fit hybrid workloads best.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: '7 Best HTAP Databases for Real-Time Operational Analytics',
      path: '/compare/htap-database/',
    },
  ],
})
  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'See how TiDB handles real-time analytics without ETL — read the architecture breakdown.',
        primaryCta: {
