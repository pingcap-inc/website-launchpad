...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.pingcap.com/compare/playbook-embed-vector-db-build-rag/' },
  openGraph: {
    title: 'TiDB vs Pinecone: RAG Stack Simplified | TiDB',
    description:
      "Compare TiDB's embedded vector DB approach against the classic two-DB setup for RAG. Discover how TiDB unifies vector and SQL in one system.",
    url: 'https://www.pingcap.com/compare/playbook-embed-vector-db-build-rag/',
    siteName: 'TiDB',
    images: [
      {
...
const schema = buildPageSchema({
  path: '/compare/playbook-embed-vector-db-build-rag/',
  title: 'TiDB vs Pinecone: RAG Stack Simplified | TiDB',
  description:
    "Compare TiDB's embedded vector DB approach against the classic two-DB setup for RAG. Discover how TiDB unifies vector and SQL in one system.",
  breadcrumbs: [
...
const dsl: PageDSL = {
  ...
  meta: {
    ...
    description:
      "Compare TiDB's embedded vector DB approach against the classic two-DB setup for RAG. Discover how TiDB unifies vector and SQL in one system.",
    canonical: '/compare/playbook-embed-vector-db-build-rag/',
  },
  sections: [
    {
      id: 'hero-1',
