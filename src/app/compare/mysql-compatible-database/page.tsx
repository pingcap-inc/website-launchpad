...
export const metadata: Metadata = {
  ...
  description:
    'Compare the best mysql compatible database options for scale, analytics, and operations. See which tools fit MySQL teams in 2026.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: '7 Best MySQL-Compatible Databases for Modern Workloads',
      path: '/compare/mysql-compatible-database/',
    },
  ],
})
