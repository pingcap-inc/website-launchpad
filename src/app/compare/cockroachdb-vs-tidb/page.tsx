...
export const metadata: Metadata = {
  ...
  description:
    'Compare TiDB vs CockroachDB on compatibility, ACID transactions, scaling, HTAP analytics, multi-region tradeoffs, ops, and pricing—then pick the best fit.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'TiDB vs CockroachDB (2026) Comparison Guide for Platform Teams',
      path: '/compare/cockroachdb-vs-tidb/',
    },
  ],
})
  ...
  sections: [
    {
      ...
      props: {
        layout: 'image-right',
        headline: 'TiDB vs CockroachDB (2026) Comparison Guide for Platform Teams',
        heroImage: {
          image: {
            url: 'https://static.pingcap.com/images/0525206a-tidb-vs-cockroachdb-banner.svg',
            alt: 'tidb vs cockroachdb banner',
            width: 590,
            height: 450,
          },
          alt: 'tidb vs cockroachdb banner',
    ...
    },
    {
      ...
      props: {
        items: [
          ...
          {
            id: 'tidb-vs-cockroachdb-side-by-side-comparison',
            label: 'TiDB vs CockroachDB: Side-by-Side Comparison',
            level: 1,
          },
          {
          ...
          {
            id: 'tidb-vs-cockroachdb-overview-2-minute-summary',
            label: 'TiDB vs CockroachDB Overview: 2-Minute Summary',
            level: 1,
          },
          {
            id: 'tidb-in-brief',
          ...
          {
            id: 'cockroachdb-in-brief',
            label: 'CockroachDB in Brief',
            level: 2,
          },
          {
            id: 'when-this-comparison-matters',
            label: 'When This Comparison Matters',
            level: 2,
          },
          {
            id: 'key-differences-tidb-vs-cockroachdb-what-buyers-should-know-first',
            label: 'Key Differences: TiDB vs CockroachDB - What Buyers Should Know First',
            level: 1,
          },
          {
            id: 'mysql-compatibility-vs-postgres-wire-compatibility-tradeoffs',
            label: 'MySQL Compatibility vs Postgres Wire-Compatibility Tradeoffs',
            level: 2,
          },
          {
            id: 'htap-path-tiflash-vs-external-analytics-patterns',
            label: 'HTAP Path: TiFlash vs External Analytics Patterns',
            level: 2,
          },
          {
            id: 'scaling-approach-partitioning-vs-no-manual-sharding-operational-reality',
            label: 'Scaling Approach: Partitioning vs ‘No Manual Sharding’ Operational Reality',
            level: 2,
          },
          {
            id: 'distributed-transactions-consistency-model-differences',
            label: 'Distributed Transactions & Consistency Model Differences',
            level: 2,
          },
          {
            id: 'multi-region-database-design-locality-latency-and-write-path-constraints',
            label: 'Multi-Region Database Design: Locality, Latency, and Write-Path Constraints',
            level: 2,
          },
          {
            id: 'operational-model-self-managed-vs-managed-service-expectations',
            label: 'Operational Model: Self-Managed vs Managed Service Expectations',
            level: 2,
          },
          {
          ...
          {
            id: 'tidb-architecture-compute-storage-separation',
            label: 'TiDB Architecture: Compute + Storage Separation',
            level: 2,
          },
          {
            id: 'cockroachdb-architectur',
            label: 'CockroachDB Architectur',
            level: 2,
          },
          {
            id: 'elasticity-decoupled-components-vs-co-located-nodes',
            label: 'Elasticity: Decoupled Components vs Co-Located Nodes',
            level: 2,
          },
          {
            id: 'timestamp-ordering-pd-based-tso-vs-hybrid-logical-clocks-hlc',
            label: 'Timestamp Ordering: PD-based TSO vs Hybrid Logical Clocks (HLC)',
            level: 2,
          },
          {
            id: 'storage-engine-rocksdb-tikv-vs-pebble-cockroachdb',
            label: 'Storage Engine: RocksDB (TiKV) vs Pebble (CockroachDB)',
            level: 2,
          },
          {
            id: 'what-architecture-means-for-real-workloads',
            label: 'What Architecture Means for Real Workloads',
            level: 2,
          },
          {
            id: 'compatibility-mysql-compatibility-vs-postgres-ecosystem',
            label: 'Compatibility: MySQL Compatibility vs Postgres Ecosystem',
            level: 1,
          },
          {
            id: 'tidb-mysql-compatible-distributed-database',
            label: 'TiDB: MySQL Compatible Distributed Database',
            level: 2,
          },
          {
            id: 'cockroachdb-postgres-compatibility',
            label: 'CockroachDB: Postgres Compatibility',
            level: 2,
          },
          {
            id: 'practical-migration-checklist',
            label: 'Practical Migration Checklist',
            level: 2,
          },
          {
            id: 'consistency-isolation-and-acid-transactions-distributed-transactions-explained',
            label:
              'Consistency, Isolation, and ACID Transactions:  Distributed Transactions Explained',
            level: 1,
          },
          {
            id: 'isolation-levels-at-a-glance-tidb-vs-cockroachdb',
            label: 'Isolation Levels at a Glance (TiDB vs CockroachDB)',
            level: 2,
          },
          {
            id: 'transaction-modes-under-contention-optimistic-vs-pessimistic',
            label: 'Transaction Modes Under Contention (Optimistic vs Pessimistic)',
            level: 2,
          },
          {
            id: 'tidb-acid-transactions-at-scale-distributed-transactions-basics',
            label: 'TiDB ACID Transactions at Scale - Distributed Transactions Basics',
            level: 2,
          },
          {
            id: 'cockroachdb-transaction-model-overview',
            label: 'CockroachDB Transaction Model Overview',
            level: 2,
          },
          {
            id: 'what-to-test-in-a-poc',
            label: 'What to Test in a POC',
            level: 2,
          },
          {
            id: 'scaling-performance-horizontal-scaling-without-the-headaches',
            label: 'Scaling & Performance: Horizontal Scaling Without the Headaches',
            level: 1,
          },
          {
            id: 'tidb-scale-out-model-horizontal-scaling-sql-database',
            label: 'TiDB Scale-Out Model: Horizontal Scaling SQL Database',
            level: 2,
          },
          {
            id: 'cockroachdb-scale-out-model',
            label: 'CockroachDB Scale-Out Model',
            level: 2,
          },
          {
            id: 'schema-object-scale-tables-indexes-and-tenancy-footprint',
            label: 'Schema Object Scale: Tables, Indexes, and Tenancy Footprint',
            level: 2,
          },
          {
            id: 'hot-lookup-tables-cached-tables-vs-general-block-cache',
            label: 'Hot Lookup Tables: Cached Tables vs General Block Cache',
            level: 2,
          },
          {
            id: 'resource-management-workload-isolation-controls-vs-admission-control',
            label: 'Resource Management: Workload Isolation Controls vs Admission Control',
            level: 2,
          },
          {
            id: 'sharding-vs-partitioning-what-you-manage-vs-what-the-db-manages',
            label: 'Sharding vs Partitioning: What You Manage vs What the DB Manages',
            level: 2,
          },
          {
            id: 'benchmarking-guidance-how-to-compare-fairly',
            label: 'Benchmarking Guidance: How to Compare Fairly',
            level: 2,
          },
          {
            id: 'mini-benchmark-rubric',
            label: 'Mini Benchmark Rubric',
            level: 2,
          },
          {
            id: 'htap-analytics-real-time-oltp-olap-on-fresh-data',
            label: 'HTAP / Analytics: Real-Time OLTP + OLAP on Fresh Data',
            level: 1,
          },
          {
            id: 'tidb-htap-with-tiflash',
            label: 'TiDB HTAP with TiFlash',
            level: 2,
          },
          {
            id: 'cockroachdb-analytics-approaches',
            label: 'CockroachDB Analytics Approaches',
            level: 2,
          },
          {
            id: 'common-htap-use-cases-to-compare',
            label: 'Common HTAP Use Cases to Compare',
            level: 2,
          },
          {
            id: 'multi-region-database-reality-check-latency-locality-and-tradeoffs',
            label: 'Multi-Region Database Reality Check: Latency, Locality, and Tradeoffs',
            level: 1,
          },
          {
            id: 'common-multi-region-topologies-and-which-teams-need-them',
            label: 'Common Multi-Region Topologies and Which Teams Need Them',
            level: 2,
          },
          {
            id: 'tidb-multi-region-patterns',
            label: 'TiDB Multi-Region Patterns',
            level: 2,
          },
          {
            id: 'cockroachdb-multi-region-patterns',
            label: 'CockroachDB Multi-Region Patterns',
            level: 2,
          },
          {
            id: 'decision-rule-when-multi-region-becomes-a-requirement-vs-a-nice-to-have',
            label: 'Decision Rule: When “Multi-Region” Becomes a Requirement vs a Nice-to-Have',
            level: 2,
          },
          {
            id: 'operations-reliability-upgrades-backups-and-online-schema-change',
            label: 'Operations & Reliability: Upgrades, Backups, and Online Schema Change',
            level: 1,
          },
          {
            id: 'zero-downtime-schema-changes-online-ddl',
            label: 'Zero-Downtime Schema Changes: Online DDL',
            level: 2,
          },
          {
            id: 'upgrades-and-maintenance-windows-what-to-expect',
            label: 'Upgrades and Maintenance Windows - What to Expect',
            level: 2,
          },
          {
            id: 'backup-restore-pitr-and-disaster-recovery-considerations',
            label: 'Backup/Restore, PITR, and Disaster Recovery Considerations',
            level: 2,
          },
          {
            id: 'observability-and-day-2-operations-checklist',
            label: 'Observability and Day-2 Operations Checklist',
            level: 2,
          },
          {
            id: 'ecosystem-integrations-kubernetes-data-movement-tooling',
            label: 'Ecosystem & Integrations: Kubernetes, Data Movement, Tooling',
            level: 1,
          },
          {
          ...
          {
            id: 'developer-tooling-and-operational-tooling-expectations',
            label: 'Developer Tooling and Operational Tooling Expectations',
            level: 2,
          },
          {
            id: 'implementation-migration-plan-how-to-de-risk-the-move',
            label: 'Implementation / Migration Plan: How to De-Risk the Move',
            level: 1,
          },
          {
            id: 'step-1-compatibility-assessment-schema-queries',
            label: 'Step 1 — Compatibility Assessment: Schema + Queries',
            level: 2,
          },
          {
            id: 'step-2-data-migration-and-validation-strategy',
            label: 'Step 2 — Data Migration and Validation Strategy',
            level: 2,
          },
          {
            id: 'step-3-cutover-approach-dual-write-vs-planned-cutover',
            label: 'Step 3 — Cutover Approach: Dual-Write vs Planned Cutover',
            level: 2,
          },
          {
            id: 'step-4-performance-failure-testing-runbook',
            label: 'Step 4 — Performance + Failure Testing Runbook',
            level: 2,
          },
          {
            id: 'step-5-production-readiness-checklist',
            label: 'Step 5 — Production Readiness Checklist',
            level: 2,
          },
          {
            id: 'pricing-cost-drivers-what-actually-moves-the-bill',
            label: 'Pricing & Cost Drivers: What Actually Moves the Bill',
            level: 1,
          },
          {
            id: 'tidb-self-managed-vs-tidb-cloud-pricing-model',
            label: 'TiDB: Self-Managed vs TiDB Cloud Pricing Model',
            level: 2,
          },
          {
            id: 'cockroachdb-pricing-model-overview',
            label: 'CockroachDB: Pricing Model Overview',
            level: 2,
          },
          {
            id: 'cost-driver-checklist',
            label: 'Cost Driver Checklist',
            level: 2,
          },
          {
            id: 'pros-cons',
          ...
          {
            id: 'cockroachdb-pros',
            label: 'CockroachDB — Pros',
            level: 2,
          },
          {
            id: 'cockroachdb-cons-tradeoffs',
            label: 'CockroachDB — Cons / Tradeoffs',
            level: 2,
          },
          {
        ...
        items: [
          {
            ...
            a: 'TiDB is MySQL-compatible at the protocol level and supports common MySQL syntax and drivers, but it is not guaranteed to be 100% identical for every MySQL feature or edge case. The safest approach is a focused POC on your top queries, schema features, and operational workflows. If your app relies heavily on MySQL-specific features, validate those early.',
          },
          {
            q: 'How does TiDB handle distributed transactions and ACID transactions?',
            a: 'TiDB supports ACID transactions across a distributed cluster, which means transaction coordination can involve multiple nodes. In practice, you validate correctness, contention behavior, and tail latency under your expected failure domains. Learn more: [ACID transactions in a distributed SQL database (TiDB)](https://www.pingcap.com/blog/distributed-transactions-tidb/?utm_source=chatgpt.com).',
          },
          {
            q: 'What does HTAP mean, and how does TiFlash work?',
            a: 'HTAP means running operational (OLTP) and analytical (OLAP) queries on the same underlying data with minimal lag. TiDB enables an HTAP path using TiFlash columnar replicas alongside TiKV, so analytical scans can be isolated from transactional workloads. Learn more: [HTAP database fundamentals and TiDB HTAP use cases](https://www.pingcap.com/blog/harnessing-the-power-of-htap-databases/?utm_source=chatgpt.com).',
          },
          {
            q: 'Do I need database sharding or database partitioning with TiDB?',
            a: 'TiDB is designed to scale out without requiring application-owned database sharding as the default approach, but you may still use database partitioning for manageability or pruning. The right question is what you want to own operationally: shard routing and resharding, or a cluster that manages distribution for you. Learn more: [Database sharding explained (and when to avoid it)](https://www.pingcap.com/blog/database-sharding-defined/?utm_source=chatgpt.com).',
          },
          {
            q: 'How do online DDL / online schema changes work in TiDB?',
            a: 'Online DDL aims to change schemas without taking the database offline, but you still validate duration and workload impact under production-like load. Your POC should include a representative large-table schema change and measure tail latency during the operation. Learn more: [Online DDL / online schema change with zero downtime](https://www.pingcap.com/blog/effective-online-ddl-database-schema-changes-zero-downtime/).',
          },
          {
            q: 'How should I evaluate TiDB vs CockroachDB performance for my workload?',
            a: 'Use your real schema and query mix, then test production-like concurrency and tail latency (p95/p99), not just averages. Include failure-mode drills and measure how performance changes during node loss, rebalancing, and contention hotspots. Finally, model cost with equivalent availability and multi-region assumptions.',
          },
        ],
      },
      style: {
