...
export const metadata: Metadata = {
  ...
  description:
    'Discover the top databases for AI apps in 2026. Compare TiDB, Pinecone, Weaviate, and more for RAG, vector search, and real-time data.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'Best Databases for AI Applications (2026): Top Picks for RAG, Vector Search & Real-Time Data',
      path: '/compare/best-database-building-ai-apps/',
    },
  ],
})
...
const dsl: PageDSL = {
  pageName:
    'Best Databases for AI Applications (2026): Top Picks for RAG, Vector Search & Real-Time Data',
  meta: {
    title: 'Best Databases for AI Applications (2026) | TiDB',
    description:
      'Discover the top databases for AI apps in 2026. Compare TiDB, Pinecone, Weaviate, and more for RAG, vector search, and real-time data.',
  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'One system for SQL, vector search, and real-time analytics — no sync pipelines needed.',
        primaryCta: {
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'Eliminate the Memory Wall — SQL, vector search, and HTAP analytics in a single cluster.',
        primaryCta: {
          text: 'Try TiDB Cloud',
          href: 'https://www.pingcap.com/tidb/cloud/',
        },
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'Discover the power of vector search in a distributed database. Free tier, no credit card needed.',
        primaryCta: {
          text: 'Try TiDB Cloud',
          href: 'https://www.pingcap.com/tidb/cloud/',
        },
