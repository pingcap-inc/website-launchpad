...
const dsl: PageDSL = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "props": {
        "items": [
          ...
          {
            "id": "tidb-vs-postgresql-faqs",
            "label": "TiDB vs PostgreSQL FAQs",
            "level": 1
          },
          {
            "id": "is-tidb-postgresql-compatible",
            "label": "Is TiDB PostgreSQL Compatible?",
            "level": 2
          },
          {
            "id": "is-tidb-faster-than-postgresql",
            "label": "Is TiDB Faster Than PostgreSQL?",
            "level": 2
          },
          {
            "id": "can-postgresql-scale-horizontally",
            "label": "Can PostgreSQL Scale Horizontally?",
            "level": 2
          },
          {
            "id": "when-should-you-move-from-postgresql-to-tidb",
            "label": "When Should You Move from PostgreSQL to TiDB?",
            "level": 2
          },
          {
            "id": "which-database-is-better-for-analytics-and-ai-workloads",
            "label": "Which Database Is Better for Analytics and AI Workloads?",
            "level": 2
          }
        ],
        "sticky": true
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Eliminate Patroni, Citus, and ETL pipelines — benchmark TiDB against your PostgreSQL baselines.",
        "primaryCta": {
          "text": "Try TiDB Cloud Free",
          "href": "https://www.pingcap.com/tidb/cloud/"
        },
