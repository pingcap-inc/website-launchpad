...
const dsl: PageDSL = {
  "pageName": "TiDB vs PostgreSQL (2026) Comparison Guide for Platform Teams",
  "meta": {
    "title": "TiDB vs PostgreSQL (2026): A Platform Team's Guide | TiDB",
    "description": "Compare TiDB and PostgreSQL for scale-out, high availability, and real-time analytics. Choose the right database for your cloud-native apps.",
  ...
  "sections": [
    {
      ...
      "props": {
        "layout": "image-right",
        "headline": "TiDB vs PostgreSQL (2026) Comparison Guide for Platform Teams",
        "heroImage": {
          "image": {
            "url": "https://static.pingcap.com/images/e3d29e15-group-1000011601.png",
            "alt": "group 1000011601",
            "width": 590,
            "height": 450
          },
          "alt": "group 1000011601",
    ...
    },
    {
      ...
      "props": {
        "items": [
          ...
          {
            "id": "tidb-vs-postgresql-at-a-glance",
            "label": "TiDB vs PostgreSQL at a Glance",
            "level": 1
          },
          {
            "id": "key-differences-that-change-workload-fit",
            "label": "Key Differences That Change Workload Fit",
            "level": 2
          },
          {
            "id": "how-tidb-vs-postgresql-differs-in-architecture",
            "label": "How TiDB vs PostgreSQL Differs in Architecture",
            "level": 1
          },
          {
            "id": "why-tidb-scales-out-differently",
            "label": "Why TiDB Scales Out Differently",
            "level": 2
          },
          {
            "id": "why-postgresql-remains-strong-on-single-node-maturity",
            "label": "Why PostgreSQL Remains Strong on Single-Node Maturity",
            "level": 2
          },
          {
            "id": "which-database-performs-better-as-workloads-grow",
            "label": "Which Database Performs Better as Workloads Grow?",
            "level": 1
          },
          {
            "id": "tidb-vs-postgresql-performance-for-oltp",
            "label": "TiDB vs PostgreSQL Performance for OLTP",
            "level": 2
          },
          {
            "id": "tidb-vs-postgresql-performance-for-analytics",
            "label": "TiDB vs PostgreSQL Performance for Analytics",
            "level": 2
          },
          {
            "id": "key-differences-that-affect-latency-and-throughput",
            "label": "Key Differences That Affect Latency and Throughput",
            "level": 2
          },
          {
            "id": "what-to-benchmark-in-a-poc",
            "label": "What to Benchmark in a POC",
            "level": 2
          },
          {
            "id": "how-tidb-vs-postgresql-handles-scalability-and-high-availability",
            "label": "How TiDB vs PostgreSQL Handles Scalability and High Availability",
            "level": 1
          },
          {
            "id": "tidb-vs-postgresql-scalability-for-growing-saas-apps",
            "label": "TiDB vs PostgreSQL Scalability for Growing SaaS Apps",
            "level": 2
          },
          {
            "id": "how-failover-and-replication-differ",
            "label": "How Failover and Replication Differ",
            "level": 2
          },
          {
            "id": "when-operational-simplicity-matters-more-than-raw-familiarity",
            "label": "When Operational Simplicity Matters More Than Raw Familiarity",
            "level": 2
          },
          {
            "id": "how-do-integrations-analytics-and-ai-workloads-compare",
            "label": "How Do Integrations, Analytics, and AI Workloads Compare?",
            "level": 1
          },
          {
            "id": "postgresql-extensions-and-ecosystem-depth",
            "label": "PostgreSQL Extensions and Ecosystem Depth",
            "level": 2
          },
          {
            "id": "tidb-for-real-time-analytics-and-modern-data-workloads",
            "label": "TiDB for Real-Time Analytics and Modern Data Workloads",
            "level": 2
          },
          {
            "id": "what-do-deployment-governance-support-and-pricing-model-look-like",
            "label": "What Do Deployment, Governance, Support, and Pricing Model Look Like?",
            "level": 1
          },
          {
            "id": "managed-service-vs-self-managed-tradeoffs",
            "label": "Managed Service vs Self-Managed Tradeoffs",
            "level": 2
          },
          {
            "id": "how-to-compare-pricing-without-oversimplifying-cost",
            "label": "How to Compare Pricing Without Oversimplifying Cost",
            "level": 2
          },
          {
            "id": "support-and-governance-considerations-for-enterprise-teams",
            "label": "Support and Governance Considerations for Enterprise Teams",
            "level": 2
          },
          {
            "id": "who-should-choose-tidb-and-who-should-choose-postgresql",
            "label": "Who Should Choose TiDB and Who Should Choose PostgreSQL?",
            "level": 1
          },
          {
            "id": "choose-tidb-if",
          ...
          {
            "id": "choose-postgresql-if",
            "label": "Choose PostgreSQL If…",
            "level": 2
          },
          {
            "id": "how-tidb-helps-teams-outgrow-postgresql-limits",
            "label": "How TiDB Helps Teams Outgrow PostgreSQL Limits",
            "level": 1
          },
          {
            "id": "when-tidb-becomes-the-better-next-step",
            "label": "When TiDB Becomes the Better Next Step",
            "level": 2
          },
          {
            "id": "start-your-evaluation",
            "label": "Start Your Evaluation",
            "level": 2
          },
          {
            "id": "faq-1778619959606",
            "label": "TiDB vs PostgreSQL FAQs",
            "level": 1
          }
        ],
        "sticky": true
    ...
    },
    {
      ...
      "type": "richTextBlock",
      "props": {
        "content": "**Updated April 27, 2026 | Author: [Brian Foster](https://www.pingcap.com/blog/author/brian-james-foster/) (Content Director) | Reviewed by: Ravish Patel (Solutions Engineer)**\n\n---\n\nTiDB and PostgreSQL both speak SQL, but they are built for different scaling realities. PostgreSQL is a proven relational database for workloads that fit on a single server, backed by a rich extension ecosystem and decades of community refinement. TiDB is a MySQL-compatible distributed SQL database designed for horizontal scale-out with ACID transactions, automatic high availability, and an HTAP path to run operational analytics on fresh OLTP data via TiKV and TiFlash.\n\n**Verdict:** Choose PostgreSQL when your workload fits comfortably on a single well-provisioned server and you want the broadest extension ecosystem and managed service selection. Choose TiDB when you need elastic horizontal scaling, automatic failover with zero data loss, and real-time analytics on live transactional data without building a separate warehouse pipeline.\n\n## Jump to a Section\n\n- [TiDB vs PostgreSQL at a Glance](#tidb-vs-postgresql-at-a-glance)\n- [Architecture Differences](#how-tidb-vs-postgresql-differs-in-architecture)\n- [Performance as Workloads Grow](#which-database-performs-better-as-workloads-grow)\n- [Scalability and High Availability](#how-tidb-vs-postgresql-handles-scalability-and-high-availability)\n- [Integrations, Analytics, and AI Workloads](#how-do-integrations-analytics-and-ai-workloads-compare)\n- [Deployment, Governance, Support, and Pricing](#what-do-deployment-governance-support-and-pricing-model-look-like)\n- [Who Should Choose Which](#who-should-choose-tidb-and-who-should-choose-postgresql)\n- [When TiDB Becomes the Better Next Step](#how-tidb-helps-teams-outgrow-postgresql-limits)\n- [FAQs](#tidb-vs-postgresql-faqs)\n\n## TiDB vs PostgreSQL at a Glance\n\n:::card tone=light\n\n**Key Takeaways:**\n- Choose TiDB if you are hitting (or approaching) single-server scaling limits and want to avoid application-level sharding.\n- Choose TiDB if you need automatic high availability with Raft-based zero-data-loss failover and no external HA tooling to maintain.\n- Choose TiDB if you need real-time analytics on operational data and want to reduce ETL lag and dual-system complexity.\n- Choose PostgreSQL if your workload fits a single primary and you want the simplest operational model with the richest extension ecosystem.\n- Choose PostgreSQL if you depend on PostgreSQL-specific extensions (PostGIS, pgvector, pg_cron) that are central to your architecture.\n\n:::\n\nThe core tradeoff: TiDB trades single-node depth and PostgreSQL's extension ecosystem for built-in horizontal scaling, automatic high availability, and integrated real-time analytics.\n\n| Criteria | TiDB | PostgreSQL | Best Fit |\n|---|---|---|---|\n| Architecture | Distributed SQL (compute + storage separation). TiDB Server + TiKV + PD + optional TiFlash. | Single-node relational database with optional extensions for distribution (Citus). | TiDB when data or traffic outgrows a single node. PostgreSQL for smaller, single-node workloads. |\n| Scaling model | Horizontal scaling: add TiDB nodes for compute, TiKV nodes for storage. No manual sharding. | Vertical scaling by default. Horizontal reads via streaming replication. Write scale-out requires Citus or manual sharding. | TiDB when write scaling or automatic sharding is needed. |\n| High Availability | Built-in via Raft consensus (TiKV). Automatic failover, self-healing. No additional tooling required. | Requires external tooling (Patroni, repmgr, pg_auto_failover) for automated HA and failover. | TiDB for simpler HA operations at scale. |\n| Analytics / HTAP | TiFlash columnar engine provides real-time OLAP on live OLTP data without ETL. | Strong single-node OLAP via parallel query, table partitioning, and materialized views. Heavy analytics typically offloaded. | TiDB when you need analytics on fresh transactional data without a separate pipeline. |\n| Ecosystem | MySQL-compatible drivers and ORMs. TiCDC for streaming. Growing integration catalog. | Massive extension ecosystem: PostGIS, pgvector, TimescaleDB, pg_trgm, Citus, and thousands more. | PostgreSQL when extension breadth is a primary requirement. |\n| Deployment | Self-managed (VMs/K8s via TiDB Operator) or TiDB Cloud (AWS, GCP, Azure, and Alibaba Cloud). | Self-managed, or managed via Amazon RDS/Aurora, Azure Database, Google Cloud SQL, Supabase, Neon, and others. | Similar managed options; TiDB Cloud adds HTAP and scale-out natively. |\n| Pricing Model | OSS (Apache 2.0) self-managed or TiDB Cloud (free, usage-based, and provisioned tiers). | OSS (PostgreSQL License) self-managed or managed service pricing per provider. | Both free for self-managed; compare managed service costs under your workload. |\n| SQL Dialect | MySQL protocol and syntax. | PostgreSQL protocol and syntax. | Depends on your existing stack and team expertise. |\n\n*Table: TiDB vs PostgreSQL side-by-side comparison across architecture, scaling model, HA, analytics, ecosystem, deployment, pricing, and SQL dialect.*\n\n### Key Differences That Change Workload Fit\n\nTwo factors most often separate \"PostgreSQL is good enough\" from \"we need a different architecture.\"\n\nThe first is **scaling model**. PostgreSQL scales vertically until it hits hardware limits, then requires Citus, manual sharding, or read replicas — each adding operational complexity. TiDB scales by adding nodes, with no application-level sharding logic required.\n\nThe second is **analytics architecture**. PostgreSQL can run analytics on a single node, but heavy OLAP queries compete with OLTP traffic for shared resources. TiDB's TiFlash runs analytical workloads on isolated columnar replicas without impacting transactional performance, eliminating the need for a separate data warehouse for many operational analytics use cases.",
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "See how TiDB handles the scale your PostgreSQL deployment is approaching.",
        "primaryCta": {
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Eliminate Patroni, Citus, and ETL pipelines by benchmarking TiDB against your PostgreSQL baselines.",
        "primaryCta": {
          "text": "Try TiDB Cloud Free",
          "href": "https://www.pingcap.com/tidb/cloud/"
        },
        "secondaryCta": {
          "text": "Escape MySQL/PostgreSQL Sharding Pain",
    ...
    },
    {
      ...
      "type": "faq",
      "props": {
        "title": "TiDB vs PostgreSQL FAQs",
        "items": [
          {
            "q": "Is TiDB PostgreSQL Compatible?",
            "a": "No. TiDB is MySQL-compatible, not PostgreSQL-compatible. Migrating from PostgreSQL to TiDB requires adapting queries to MySQL syntax and updating drivers and ORMs."
          },
          {
            "q": "Is TiDB Faster Than PostgreSQL?",
            "a": "It depends on the workload. PostgreSQL often has lower single-query latency on local data because there is no distributed coordination overhead. As concurrency and data volume grow, TiDB maintains more stable p95/p99 latency by spreading load across nodes. For analytical queries, TiDB's TiFlash columnar engine is significantly faster than row-oriented PostgreSQL scans."
          },
          {
            "q": "Can PostgreSQL Scale Horizontally?",
            "a": "Not natively for writes. PostgreSQL scales reads via streaming replication and can distribute writes using Citus, but Citus introduces constraints around co-located joins, cross-shard transactions, and coordinator management. TiDB handles horizontal scaling natively — automatic sharding, rebalancing, and distributed transactions — without extensions or application changes."
          },
          {
            "q": "When Should You Move from PostgreSQL to TiDB?",
            "a": "Consider the move when write throughput requires increasingly expensive vertical scaling, your HA toolchain (Patroni, repmgr) is consuming significant operational capacity, or analytics workloads are impacting OLTP performance. TiDB consolidates scale-out writes, built-in HA, and HTAP analytics into a single system."
          },
          {
            "q": "Which Database Is Better for Analytics and AI Workloads?",
            "a": "For analytics, TiDB's TiFlash provides real-time columnar analytics on live transactional data without ETL. PostgreSQL handles moderate analytics on a single node but heavy workloads need a separate OLAP system. For AI/vector workloads, PostgreSQL's pgvector is more mature today; TiDB supports vector types and indexes but with a narrower ecosystem. Choose based on whether operational analytics at scale or extension depth matters more."
          }
        ]
      },
      "style": {
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Ready to benchmark TiDB against your PostgreSQL baselines? Start with a free cluster — no credit card required.",
        "primaryCta": {
          "text": "Try TiDB Cloud Free",
          "href": "https://www.pingcap.com/tidb/cloud/"
        },
        "secondaryCta": {
          "text": "TiDB vs Traditional Databases: Scalability and Performance",
          "href": "https://www.pingcap.com/article/tidb-vs-traditional-databases-scalability-and-performance/"
        }
      },
      "style": {
        "background": "brand-violet",
