      ...
      "props": {
        ...
        "items": [
          ...
          },
          {
            ...
            "description": "Query latency, data freshness, and concurrency under load. Covers pure OLAP engines, streaming-first systems, and HTAP databases — and when each architecture is the right call.",
            "href": "https://www.pingcap.com/compare/best-databases-for-real-time-analytics/"
          },
          {
            "icon": "Puzzle",
            "title": "Best HTAP Database",
            "description": "What it actually means to run transactions and analytics on the same live data. Covers architecture trade-offs, freshness guarantees, and how HTAP compares to a dedicated pipeline.",
