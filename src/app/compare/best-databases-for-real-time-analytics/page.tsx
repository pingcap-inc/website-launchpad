...
export const metadata: Metadata = {
  ...
  description:
    'Compare the top 7 databases for real-time analytics in 2026. Find the best OLAP, streaming, and HTAP tools for your low-latency dashboards.',
  robots: { index: true, follow: true },
  alternates: {
    canonical: 'https://www.pingcap.com/compare/best-databases-for-real-time-analytics/',
  },
  openGraph: {
    title: '7 Best Databases for Real-Time Analytics in 2026 | TiDB',
    description:
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: '7 Best Databases for Real-Time Analytics in 2026',
      path: '/compare/best-databases-for-real-time-analytics/',
    },
  ],
})
