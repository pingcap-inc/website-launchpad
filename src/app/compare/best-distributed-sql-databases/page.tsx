...
export const metadata: Metadata = {
  ...
  description: "Compare top distributed SQL databases for global scale, ACID transactions, HTAP, and cloud options. See tradeoffs and try TiDB Cloud.",
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    { name: "Best Distributed SQL Databases 2026", path: "/compare/best-distributed-sql-databases/" },
  ],
})
...
const dsl: PageDSL = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "props": {
        "title": "",
        "subtitle": "Ready to go beyond sharded MySQL? Evaluate TiDB against your production workload.",
        "primaryCta": {
          "text": "Try TiDB Cloud for distributed SQL",
          "href": "https://www.pingcap.com/tidb/cloud/"
        }
