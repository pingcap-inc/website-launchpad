...
export const metadata: Metadata = {
  ...
  description:
    'Compare Vitess vs TiDB across sharding, consistency, Kubernetes, and operations. See which approach fits MySQL scale-out and distributed SQL needs.',
  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'Stop spending engineering cycles on sharding workflows that grow with your database fleet.',
        primaryCta: {
