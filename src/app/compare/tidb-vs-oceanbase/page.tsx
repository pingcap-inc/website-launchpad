...
export const metadata: Metadata = {
  ...
  description:
    'Compare TiDB vs OceanBase across HTAP, OLTP, architecture, cloud operations, and ecosystem fit so your team can choose with confidence.',
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'TiDB vs OceanBase: How to Choose the Right Distributed SQL Database',
      path: '/compare/tidb-vs-oceanbase/',
    },
  ],
})
  ...
  sections: [
    {
      ...
      props: {
        ...
        heroImage: {
          image: {
            url: 'https://static.pingcap.com/images/4aacc283-1000011605.svg',
            alt: '1000011605',
            width: 590,
            height: 450,
          },
