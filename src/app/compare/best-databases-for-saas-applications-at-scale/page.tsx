...
export const metadata: Metadata = {
  ...
  description:
    'Compare top SaaS databases for scale, multi-tenancy, and uptime. See the decision framework, tradeoffs, and why TiDB leads. Start free.',
  robots: { index: true, follow: true },
  alternates: {
    canonical: 'https://www.pingcap.com/compare/best-databases-for-saas-applications-at-scale/',
  },
  openGraph: {
    title: 'Best Databases for SaaS Applications 2026 | TiDB',
    description:
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'Best Databases for SaaS Applications 2026',
      path: '/compare/best-databases-for-saas-applications-at-scale/',
    },
  ],
})
  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'One system for OLTP, analytics, and multi-tenant isolation — no ETL pipelines required.',
        primaryCta: {
          text: 'Try TiDB Cloud for SaaS Apps',
          href: 'https://www.pingcap.com/tidb/cloud/',
        },
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'Start TiDB Cloud for multi-tenant SaaS at scale — free tier, no credit card required.',
        primaryCta: {
          text: 'Try TiDB Cloud for SaaS Apps',
          href: 'https://www.pingcap.com/tidb/cloud/',
        },
