...
export const metadata: Metadata = {
  title: 'TiDB | TiDB vs CockroachDB (2026) Comparison Guide for Platf',
  description:
    '**Updated March 4, 2026 | Author: Brian Foster (Content Director) | Reviewed by: Ben Sherrill (Senior Solutions Engineer)**',
  robots: { index: true, follow: true },
  alternates: { canonical: 'https://www.pingcap.com/imported-page/' },
  openGraph: {
    title: 'TiDB | TiDB vs CockroachDB (2026) Comparison Guide for Platf',
    description:
      '**Updated March 4, 2026 | Author: Brian Foster (Content Director) | Reviewed by: Ben Sherrill (Senior Solutions Engineer)**',
    url: 'https://www.pingcap.com/imported-page/',
    siteName: 'TiDB',
    images: [
      {
    ...
    },
    {
      ...
      props: {
        items: [
          ...
          {
            id: 'cockroachdb-architectur-image2',
            label: 'CockroachDB Architectur![][image2]',
            level: 2,
          },
          {
