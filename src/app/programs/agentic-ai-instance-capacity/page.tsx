...
export const metadata: Metadata = {
  ...
  description:
    'Apply for the TiDB Cloud Instance Capacity Plan for agent and application platforms running large numbers of Starter instances and branches.',
  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        ...
        subtitle:
          "Tell us what you're building and the scale you expect. Our team will review your application and contact you about eligibility and onboarding.",
        portalId: '4466002',
        formId: 'e60d7785-7e6b-4654-9d82-13097bd2f6ec',
        region: 'na1',
      },
      style: {},
    },
        ...
        items: [
          {
            ...
            description:
              'The plan supports organizations that need to create and manage large numbers of active Starter instances and branches.',
            cta: {
              text: '',
              href: '',
            },
          ...
          },
          {
            ...
            description:
              'Our team will review your application and contact you about eligibility and onboarding.',
            cta: {
              text: '',
              href: '',
            },
          ...
          },
          {
            ...
            description:
              'Gain clear visibility into instance-capacity charges alongside existing usage charges in your billing dashboard.',
            cta: {
              text: '',
              href: '',
            },
