...
- **Eligibility:** Open to active participants of the TiDB Startup Program who reply to confirm
  participation before 10 October 2026. PingCAP may verify eligibility at its discretion.
  **[TBD — pending Legal: confirm this covers founders who join the Startup Program during the
  confirmation window, not only those already active when the invitation was sent.]**
...
- **Data processing:** By confirming participation, you agree that PingCAP will monitor and
  ...
  handled in accordance with PingCAP's Privacy Policy **[TBD — confirm link]** and retained only
  for as long as needed for this purpose. You may contact **[TBD — privacy contact email]** with
  questions about this processing or to exercise your data protection rights.
